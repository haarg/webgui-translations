...
our $I18N = {
	...
	'7' => {
		message => q|Desconsiderar título?|,
	...
	'equal to' => {
		message => q|igual a|,
		lastUpdated => 1096146740
	},

	'1' => {
		message => q|Proxy de que Wobject |,
	...
	'not equal to' => {
		message => q|não igual a|,
		lastUpdated => 1096146714
	},
	...
	'4' => {
		message => q|Proxy de Wobject falhou. Provavelmente o wobject original foi apagado.|,
