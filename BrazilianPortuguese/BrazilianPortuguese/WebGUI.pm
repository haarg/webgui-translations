...
our $I18N = {
	'559' => {
		message => q|Executar No Registro|,
	...
	'71' => {
		message => q|Recuperar senha|,
		lastUpdated => 1080228904
	},
	...
	'443' => {
		message => q|Dados Residenciais|,
		lastUpdated => 1080220875
	},

	'959' => {
		message => q|Esvaziar área de transferência do sistema.|,
	...
	'1050' => {
		message => q|Buscar Por|,
		lastUpdated => 1080084112
	},

	'560' => {
		message => q|Aprovado|,
		lastUpdated => 1080223426
	},
	...
	'978' => {
		...
		lastUpdated => 1080299638
	},

	'728' => {
		message => q|Você tem certeza de que quer apagar este arquivo?|,
		lastUpdated => 1080229286
	},
	...
	'325' => {
		message => q|Estado (Residencial)|,
		lastUpdated => 1080209380
	},
	...
	'889' => {
		...
		lastUpdated => 1080297745
	},

	'572' => {
		message => q|Aprovar|,
		lastUpdated => 1080223562
	},
	...
	'431' => {
		...
		lastUpdated => 1080211425
	},

	'527' => {
		message => q|Página Inicial|,
		lastUpdated => 1080222860
	},

	'861' => {
		message => q|Tornar perfil público?|,
	...
	'76' => {
		message => q|Esse endereço de email não está em nossos registros.|,
		lastUpdated => 1080229569
	},

	'340' => {
		message => q|Feminino|,
		lastUpdated => 1080209540
	},

	'62' => {
		message => q|salvar|,
		lastUpdated => 1080228618
	},

	'311' => {
		message => q|Habilitar dados residenciais?|,
		lastUpdated => 1080301785
	},

	'982' => {
		message => q|Adicionar um vínculo com banco de dados.|,
	...
	'859' => {
		...
		lastUpdated => 1080300349
	},

	'739' => {
		message => q|Nível da Interface Com o Usuário|,
	...
	'135' => {
		message => q|Servidor SMTP|,
		lastUpdated => 1080085780
	},
	...
	'486' => {
		...
		lastUpdated => 1080222250
	},

	'160' => {
		message => q|Enviado Em|,
		lastUpdated => 1080143407
	},

	'509' => {
		message => q|Layout da Discussão|,
	...
	'8' => {
		message => q|Ver Página Não Encontrada (erro 404).|,
		lastUpdated => 1080234687
	},

	'976' => {
		message => q|Adicionar Usuários|,
	...
	'485' => {
		message => q|Booleano (<i>Checkbox</i>)|,
		lastUpdated => 1080222233
	},

	'391' => {
		message => q|Apagar arquivo anexado.|,
		lastUpdated => 1080210640
	},

	'743' => {
		message => q|Você deve especificar um endereço de email válido para recuperar a sua senha.|,
	...
	'453' => {
		message => q|Criado Em|,
		lastUpdated => 1080221433
	},

	'324' => {
		message => q|Cidade (Residencial)|,
	...
	'87' => {
		...
		lastUpdated => 1080236207
	},

	'77' => {
		message => q|O nome de usuário que você escolheu já está sendo utilizado por outro membro. Por favor, escolha outro nome. A seguir, estão algumas sugestões:|,
	...
	'64' => {
		message => q|Sair.|,
		lastUpdated => 1080236113
	},

	'558' => {
		message => q|Editar o <i>Karma</i> do Usuário|,
	...
	'881' => {
		message => q|Nenhum|,
		lastUpdated => 1080242469
	},

	'312' => {
		message => q|Habilitar dados profissionais?|,
	...
	'965' => {
		...
		lastUpdated => 1080299324
	},

	'824' => {
		message => q|Rodapé do Email|,
		lastUpdated => 1080234714
	},

	'661' => {
		message => q|Configurações de Arquivos, Editar|,
	...
	'381' => {
		message => q|WebGUI recebeu um pedido mal-formado e não foi capaz de continuar. Uma típica causa desse erro é o envio de caracteres reservados através de um formulário. Experimente <a href="javascript:history.back(1)">voltar</a> e tentar outra vez.|,
	...
	'1073' => {
		...
		lastUpdated => 1080084823
	},

	'436' => {
		message => q|Terminar Sessão|,
	...
	'975' => {
		message => q|Usuários podem se remover deste grupo?|,
	...
	'400' => {
		message => q|Impedir Caching Via Proxy|,
		lastUpdated => 1080210715
	},
	...
	'700' => {
		message => q|Dia(s)|,
		lastUpdated => 1080302489
	},

	'475' => {
		message => q|Texto|,
		lastUpdated => 1080221884
	},

	'441' => {
		message => q|Email Para Pager|,
		lastUpdated => 1080211928
	},

	'868' => {
		message => q|Enviar mensagem de boas vindas?|,
	...
	'426' => {
		message => q|Histórico de Acessos|,
	...
	'477' => {
		message => q|Área de HTML|,
		lastUpdated => 1080222141
	},

	'815' => {
		message => q|O arquivo que você tentou transferir é grande demais.|,
	...
	'991' => {
		message => q|ID do Vínculo com Banco de Dados|,
	...
	'967' => {
		message => q|Esvaziar lixeira do sistema.|,
		lastUpdated => 1080299347
	},
	...
	'40' => {
		message => q|Componente Essencial|,
	...
	'543' => {
		message => q|Adicionar um novo grupo de imagens.|,
	...
	'941' => {
		...
		lastUpdated => 1080298672
	},

	'354' => {
		message => q|Ver Caixa de Entrada.|,
...
conteúdo da área de transferência para a lixeira?|,
	...
	'85' => {
		message => q|Descrição|,
		lastUpdated => 1080234929
	},

	'809' => {
		message => q|Enviar Email Para o Grupo|,
		lastUpdated => 1080233398
	},
	...
	'9' => {
		message => q|Ver área de transferência.|,
		lastUpdated => 1080298139
	},
	...
	'736' => {
		message => q|7 Especialista|,
		lastUpdated => 1080229432
	},

	'539' => {
		message => q|Habilitar <i>Karma</i>?|,
	...
	'90' => {
		message => q|Adicionar um novo grupo.|,
	...
	'891' => {
		message => q|Apenas não processar macros.|,
		lastUpdated => 1080298005
	},

	'1045' => {
		message => q|Sequencialmente|,
		lastUpdated => 1080084025
	},

	'532' => {
		message => q|com <strong>pelo menos uma</strong> palavra|,
	...
	'57' => {
		...
		lastUpdated => 1080235870
	},

	'368' => {
		message => q|Adicionar um novo grupo para este usuário.|,
	...
	'994' => {
		...
		lastUpdated => 1080300150
	},

	'395' => {
		message => q|Adicionar uma nova imagem.|,
	...
	'442' => {
		...
		lastUpdated => 1080220864
	},

	'429' => {
		message => q|Duração do Acesso|,
	...
	'465' => {
		message => q|Tamanho (Caracteres) da Área de Texto|,
		lastUpdated => 1080222099
	},

	'contains' => {
		message => q|Contém|,
		lastUpdated => 1096241962
	},

	'819' => {
		message => q|Auto-Desativado|,
	...
	'412' => {
		message => q|Sinopse|,
		lastUpdated => 1080211006
	},

	'954' => {
		message => q|Gerenciar área de transferência do sistema.|,
	...
	'754' => {
		message => q|Gerenciar os usuários neste grupo.|,
	...
	'159' => {
		message => q|Caixa de Entrada|,
		lastUpdated => 1080143393
	},

	'553' => {
		message => q|Estado|,
		lastUpdated => 1080223264
	},
	...
	'230' => {
		message => q|Mensagem|,
		lastUpdated => 1080301273
	},

	'1008' => {
		message => q|Texto e HTML|,
		lastUpdated => 1080082868
	},
	...
	'867' => {
		message => q|Perda de Permissões|,
		lastUpdated => 1080241997
	},

	'422' => {
		message => q|<h1>Acesso Não Permitido</h1>A informação que você forneceu não confere com os dados da conta.|,
	...
	'52' => {
		message => q|entrar|,
		lastUpdated => 1088695248
	},

	'750' => {
		message => q|Apagar este usuário.|,
	...
	'866' => {
		message => q|Mensagem de Notificação de Expiração|,
		lastUpdated => 1080242045
	},
	...
	'68' => {
		...
		lastUpdated => 1080300474
	},

	'315' => {
		message => q|Sobrenomes|,
	...
	'317' => {
		message => q|UIN <a href="http://www.icq.com/" target="_blank">ICQ</a>|,
	...
	'551' => {
		message => q|Aviso|,
		lastUpdated => 1080223249
	},

	'529' => {
		message => q|resultados por página|,
	...
	'65' => {
		message => q|Quero desativar minha conta permanentemente.|,
	...
	'435' => {
		message => q|Assinatura da Sessão|,
		lastUpdated => 1080211834
	},

	'808' => {
		message => q|Enviar email para este grupo.|,
	...
	'885' => {
		...
		lastUpdated => 1080298127
	},

	'884' => {
		message => q|Pop Up|,
		lastUpdated => 1080242532
	},
	...
	'531' => {
		message => q|com a <strong>frase exata</strong>|,
	...
	'995' => {
		message => q|Senha do Banco de Dados|,
		lastUpdated => 1080300142
	},

	'837' => {
		message => q|Pasta, Adicionar/Editar|,
	...
	'403' => {
		message => q|Prefiro não informar.|,
		lastUpdated => 1080210785
	},

	'883' => {
		message => q|<i>Inline</i> (quando suportado)|,
	...
	'848' => {
		message => q|Há um erro na sintaxe deste modelo. Por favor, corrija-o.|,
		lastUpdated => 1080302824
	},

	'421' => {
		message => q|Preservar apenas formatação básica.|,
		lastUpdated => 1080211156
	},

	'59' => {
		message => q|Esqueci minha senha.|,
		lastUpdated => 1080236094
	},
	...
	'703' => {
		message => q|Ano(s)|,
		lastUpdated => 1080302530
	},

	'864' => {
		message => q|Notificação de Expiração|,
	...
	'38' => {
		message => q|Você não tem permissões suficientes para realizar essa operação. Se for o caso, ^a(entre); como um usuário que tenha as permissões necesárias.|,
