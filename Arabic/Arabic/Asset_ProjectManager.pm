...
our $I18N = {
	...
	'task_end_label' => {
		message => q|الكلمة الدولية &quot;نهاية&quot;<br />|,
	...
	'user add popup hover' => {
		message => q|اضف مستخدم للمهمة<br />|,
		lastUpdated => 1177954065
	},

	'resourceKind' => {
		message => q|نوع المصدر اما &quot;مستخدم&quot; او &quot;مجموعة&quot;<br />|,
	...
	'project.startDate.label' => {
		message => q|العلامة الدولية ل&quot;بدء&quot;<br />|,
		lastUpdated => 1178123153
	},

	'days label abbrev' => {
		message => q|ايام|,
		lastUpdated => 1178115286
	},

	'form.header' => {
		message => q|اذا كان المستخدم في مجموعة اضافة المشاريع, سيحتوي هذا المتغير على كود نموذج اتش ت ام ال لعمل علامة تعديل مهمات العمل |,
		lastUpdated => 1178116083
	},

	'form.resourceDiv' => {
		message => q|عنصر النموذج لاختيار مستخدم للقيام بهذه المهمة<br />|,
		lastUpdated => 1178116475
	},

	'notFoundMessage' => {
		message => q|رسالة خطا دولية تخطر المستخدمين انه لم يوجد مستخدمين او مجموعات.<br />|,
		lastUpdated => 1178117967
	},

	'task predecessor edit label' => {
		message => q|سلف|,
		lastUpdated => 1178123994
	},

	'project name label' => {
		message => q|اسم المشروع<br />|,
	...
	'callback' => {
		message => q|اسم الجافا سكريبت callback للنداء<br />|,
	...
	'project.edit.url' => {
		message => q|اذا كان للمستخدم الحالي تصريح بتعديل المشروعات, سيكون لهذا المتغير رابط لتعديل المشروع<br />|,
	...
	'thursday.label' => {
		message => q|الحرف الاول من يوم الخميس بالانجليزية, دولي.<br />|,
		lastUpdated => 1177953942
	},

	'project.canEdit' => {
		message => q|شرط يحدد ما اذا كان المستخدم عضو في مجموعة تضيف المشاريع<br />|,
		lastUpdated => 1178121634
	},

	'add task label' => {
		message => q|اضف مهمة<br />|,
		lastUpdated => 1178115110
	},

	'view project template vars title' => {
		message => q|متغيرات نموذج عرض المشروع<br />|,
		lastUpdated => 1177954137
	},

	'form.start' => {
		message => q|عنصر النموذج لتاريخ بدء المهمة<br />|,
	...
	'edit task template vars title' => {
		message => q|متغيرات نموذج تعديل المهمة<br />|,
	...
	'form.duration' => {
		message => q|عنصر نموذج لمدة المهمة|,
	...
	'task.end' => {
		message => q|اذا كان المستخدم في مجموعة لاضافة المشروعات, اذا سيكون هذا المتغير مجال نموذج لتعديل تاريخ الانتهاء لهذه المهمة. دون ذلك, سيتم عرض الوقت بشكل نص.<br />|,
	...
	'form.seqNum' => {
		message => q|رقم المتتابعة لهذه المهمة<br />|,
		lastUpdated => 1178117092
	},

	'task.back.url' => {
		message => q|وصلة عودة الى هذه الشاشة<br />|,
	...
	'task.loop' => {
		message => q|دورة تحتوي كل المهمات لهذا المشروع, في شكل تتابعي<br />|,
		lastUpdated => 1177954646
	},

	'user add popup foundMessage' => {
		message => q|مستخدمين متوافقين:|,
		lastUpdated => 1177954055
	},

	'task.duration.label' => {
		message => q|الكلمة الدولية &quot;مدة&quot;<br />|,
	...
	'editTaskTemplate label' => {
		message => q|نموذج تعديل المهمة الاعتيادي<br />|,
	...
	'task resources label' => {
		message => q|قم بادارة المصادر<br />|,
	...
	'task.start' => {
		message => q|اذا كان المستخدم في مجموعة لاضافة المشروعات, اذا سيكون هذا المتغير مجال نموذج لتعديل تاريخ البدء لهذه المهمة. دون ذلك, سيتم عرض تاريخ البدء فقط.<br />|,
	...
	'no projects' => {
		message => q|قائمة المشاريع فارغة<br />|,
	...
	'project observer label' => {
		message => q|مجموعة مراقبي المشروع<br />|,
	...
	'project.resources.url' => {
		message => q|اذا كان المستخدم في مجموعة لاضافة المشاريع, سيكون هذا الرابط لشاشة ادارة المشروع |,
	...
	'projectDisplayTemplate hoverhelp' => {
		message => q|النموذج المستخدم لعرض المشاريع الفردية. النموذج الاعتيادي يظهر عرض Gantt chart للمشاريع<br />|,
	...
	'saturday.label' => {
		message => q|الحرف الاول من يوم السبت في الانجليزية, دولي<br />|,
	...
	'projectDisplayTemplateId' => {
		message => q|هوية النموذج لعرض مشروع واحد من مدير المشاريع<br />|,
	...
	'form.taskType' => {
		message => q|عنصر النموذج لاختيار نوع الهمة<br />|,
	...
	'resourceDiv' => {
		message => q|اذا كانت هذه النافذة جزء من بحث, سيحتوي هذا على اتش تي ام ال كود لعرض كل النتائج<br />|,
		lastUpdated => 1178123390
	},

	'task_duration_label' => {
		message => q|الكلمة الدولية &quot;فترة&quot;<br />|,
		lastUpdated => 1177953791
	},

	'foundResults' => {
		message => q|اذا كانت هذه النافذة جزء من البحث, سيحتوي هذا عدد النتائج التي وجدت<br />|,
		lastUpdated => 1178117196
	},

	'project.name.label' => {
		message => q|العلامة الدولية لـ &quot;اسم المشروع&quot;<br />|,
		lastUpdated => 1178123005
	},

	'project.durationUnits' => {
		message => q|نسخة ملخصة لوحدات الوقت التي تقيس المدة<br /> |,
		lastUpdated => 1178121986
	},

	'task.duration.units' => {
		message => q|وحدات المدة, عادة الساعات او الايام.<br /> |,
	...
	'ganttChartTemplateId' => {
		message => q|هوية النموذج لعرض gantt chart في مدير المشاريع<br />|,
	...
	'ganttChartTemplate hoverhelp' => {
		message => q|النموذج المستخدم لرسم gantt chart في داخل جدول<br />|,
		lastUpdated => 1178117470
	},

	'project.endDate.label' => {
		message => q|العلامة الدولية لـ &quot;نهاية&quot;<br />|,
	...
	'monday.label' => {
		message => q|<p>الحرف الاول من يوم الاثنين بالانجليزية, دولي <br /></p>|,
	...
	'task.row.id' => {
		message => q|معرف فريد مستخدم داخليا بالويب جوي لهذه المهمة<br />|,
	...
	'editTaskTemplateId' => {
		message => q|هوية النموذج لتعديل مهمة في مدير المشاريع<br /> |,
	...
	'project.actions.label' => {
		message => q|العلامة الدولية &quot;الحركات&quot;<br />|,
		lastUpdated => 1178121608
	},

	'project id' => {
		message => q|هوية المشروع<br />|,
		lastUpdated => 1178118588
	},

	'thursday label' => {
		message => q|T مختصر للخميس<br />|,
		lastUpdated => 1177953917
	},

	'project.view.url' => {
		message => q|الرابط لتذهب الى الشاشة لترى هذا المشروع<br />|,
		lastUpdated => 1178123170
	},

	'group add popup foundMessage' => {
		message => q|المجموعات المتوافقة:<br />|,
	...
	'project.complete.data.float' => {
		message => q|نسبة الانتهاء من المشروع, كرقم بشقين عشريين من اجل الدقة<br />|,
		lastUpdated => 1178121689
	},

	'task name label' => {
		message => q|اسم المهمة<br />|,
		lastUpdated => 1178123971
	},

	'task dependant label' => {
		message => q|سلف|,
		lastUpdated => 1178123876
	},

	'task greaterthan error' => {
		message => q|تاريخ البدء لا يمكن ان يكون بعد تاريخ الانتهاء<br />|,
	...
	'add resource popup template title' => {
		message => q|مدير المشاريع, نموذج&nbsp; اختيار بوب اب المصدر<br />|,
	...
	'task.dependants' => {
		message => q|اذا كان المستخدم في مجموعة لاضافة المشروعات, اذا سيكون هذا مجال نموذج لتعديل المعتمدين لهذه المهمة. دون ذلك, سيتم عرض قائمة المعتمدين نصا فقط.<br />|,
	...
	'form.invalidMove.error' => {
		message => q|رسالة الخطا الدولية لاختيار مهمة غير مصرح بها كسلف لان تاريخ النتهاء بعد تاريخ البدء لهذا الاسبوع|,
		lastUpdated => 1178116131
	},

	'form.addUser.link' => {
		message => q|الوصلة الكاملة لنافذة اضف مستخدم<br />|,
	...
	'opCallbackJs' => {
		message => q|اسم javascript callback للنموذج الذي استدعى النافذة<br />|,
	...
	'opIcon' => {
		message => q|اسم ايقونة للنموذج, بلا مسار<br />|,
	...
	'resourcePopupTemplate label' => {
		message => q|النموذج الاعتيادي لنافذة المصادر |,
	...
	'project id hoverhelp' => {
		message => q|معرف فريد يستخدم داخليا من الويب جوي للاشارة لهذا المشروع<br />|,
	...
	'editTaskTemplate hoverhelp' => {
		message => q|النموذج ليستخدم لعرض حوار تعديل المهمة<br />|,
		lastUpdated => 1178115496
	},

	'hours per day hoverhelp' => {
		message => q|  <p dir="rtl" class="MsoNormal"><span>اختر عدد الساعات الذي يمثل يوم كامل من العمل في العموم. سيعمل هذا كقاعدة يتم تقريب كم يوم تستهلكه المهمة. سيتم اجتياز هذا اذا تم ضبط العمل على عدد ساعات اقل أو اكثر في يوم. وسيتم ارفاق هذا المصدر بالمهمة:</span></p>  |,
		lastUpdated => 1178117780
	},

	'user add popup searchText' => {
		message => q|ابحث عن مستخدم<br />|,
		lastUpdated => 1177954087
	},

	'project.create' => {
		message => q|الرابط لاضافة مشروع جديد الى مدير المشاريع<br />|,
		lastUpdated => 1178121808
	},

	'task_lagTime_label' => {
		message => q|الكلمة الدولية &quot;Lag Time&quot;|,
		lastUpdated => 1177953828
	},

	'sunday.label' => {
		message => q|الحرف الاول من يوم الاحد بالانجليزية, دولي<br />|,
		lastUpdated => 1178123831
	},

	'wednesday.label' => {
		message => q|الحرف الاول من يوم الاربعاء بالانجليزية, دولي.<br />|,
	...
	'task untimedPredecessor error' => {
		message => q|المهمات غير مسموح لها بان يكون لها سلف غير مهمة موقوقتة<br />|,
		lastUpdated => 1177954271
	},

	'edit task label' => {
		message => q|عدل مهمة<br />|,
		lastUpdated => 1178115444
	},

	'list resource popup template title' => {
		message => q|مدير المشروع, نموذج نافذة تسجيل المصادر<br />|,
	...
	'groupToAdd hoverhelp' => {
		message => q|هذه المجموعة سيمكنها عمل, مسح, وتغيير الصلاحيات على المشروع. سيكون لهم ايضا صلاحيات ادارية لكل مشروع في الاصل<br />|,
	...
	'assetName' => {
		message => q|نظام ادارة المشاريع<br />|,
	...
	'task samePredecessor error' => {
		message => q|لا يمكن ان تكون المهمة هي السلف<br />|,
		lastUpdated => 1178124047
	},

	'resource remove opTitle' => {
		message => q|احذف من المهمة<br />|,
		lastUpdated => 1178123355
	},

	'project.name.data' => {
		message => q|اسم هذا المشروع<br />|,
	...
	'form.previousPredecessor.error' => {
		message => q|رسالة الخطا الدولية لاختيار مهمة سلف غير موجودة |,
	...
	'task.isMilestone' => {
		message => q|شرط يحدد ما اذا كانت هذه المهمة milestone|,
	...
	'task.duration' => {
		message => q|اذا كان المستخدم في مجموعة لاضافة المشروعات, اذا سيكون هذا المتغير مجال نموذج لتعديل المدة. دون ذلك, سيتم عرض المدة نصا فقط.<br />|,
	...
	'gantt chart template vars title' => {
		message => q|متغيرات نموذج Gantt Chart|,
		lastUpdated => 1178117437
	},

	'target budget label' => {
		message => q|تقريب تكلفة المشروع<br />|,
		lastUpdated => 1178123846
	},

	'projectDashboardTemplateId' => {
		message => q|هوية النموذج المستخدم لعرض المظهر الرئيسي لمدير المشاريع<br />|,
		lastUpdated => 1178123253
	},

	'target budget hoverhelp' => {
		message => q|ادخل التكلفة التقريبية التي يجب ان يتبعها المشروع. اذا تم ضبط مصادرك بشكل صحيح, سيقوم النظام بتتبع هذا الهدف بناء على التكاليف الحقيقية. اترك هذه القيمة على 0 اذا لم ترد متابعة تكاليف المشروع.<br />|,
		lastUpdated => 1178124316
	},

	'task.name.label' => {
		message => q|الكلمة الدولية &quot;مهمة&quot;<br />|,
		lastUpdated => 1177954663
	},

	'project.gantt.rowspan' => {
		message => q|عدد السطور في Gantt chart, 4+ هو عدد المهمات|,
		lastUpdated => 1178122857
	},
	...
	'project.ganttChart' => {
		message => q|Gantt chart لهذا المشروع ومهماته<br />|,
		lastUpdated => 1178122873
	},

	'list resource popup template body' => {
		message => q|<p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>هذا النموذج يعرض نافذة لاضافة مستخدمين او مجموعات الى مهمة. بناء على اي منهما سيضاف, متغيرات النموذج, خصوصا العلامات, ستحتوي على&nbsp; معلومات&nbsp;</p>|,
		lastUpdated => 1178117843
	},

	'edit project' => {
		message => q|عدل مشروع<br />|,
		lastUpdated => 1178115437
	},

	'assetExtras' => {
		message => q|الرابط لدليل الاضافات الخاص بمدير المشاريع<br />|,
	...
	'hours per day label' => {
		message => q|ساعات العمل في كل يوم<br />|,
		lastUpdated => 1178117792
	},

	'tuesday label' => {
		message => q|T اختضار يوم الثلاثاء|,
		lastUpdated => 1177954018
	},

	'resourceLoop' => {
		message => q|دورة تحتوي المصادر للعرض<br />|,
	...
	'edit form.footer' => {
		message => q|كود لانهاء النموذج<br />|,
		lastUpdated => 1178115396
	},

	'task lag time label' => {
		message => q|Lag Time|,
		lastUpdated => 1178123944
	},

	'task.number' => {
		message => q|رقم المتتابعة لهذه المهمة|,
	...
	'groupToAdd label' => {
		message => q|المجموعة لادارة قاءمة المشاريع<br />|,
		lastUpdated => 1178117634
	},

	'wednesday label' => {
		message => q|W أختصار يوم الاربعاء |,
	...
	'func' => {
		message => q|العملية التي يجب ان تستدعى عند الادخال<br /> |,
		lastUpdated => 1178117243
	},

	'duration units hoverhelp' => {
		message => q|اختر الوحدة للزمن التي تتبع بها مشروع. هذا سيحدد كيفية ادخال الوقت الذي تستهلكه كل مهمة.<br />|,
		lastUpdated => 1178115373
	},
