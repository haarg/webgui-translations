...
our $I18N = {
	...
	'21' => {
		message => q|المتغيرات التالية تم عملها متوفرة من لوحة في الداخل/في الخارج.<br />|,
	...
	'13 description' => {
		message => q|اختر نموذج لكي يظهر تقرير الدخول و الخروج<br />|,
	...
	'10' => {
		message => q|في الداخل<br />|,
		lastUpdated => 1173720961
	},
	...
	'16 description' => {
		message => q|قد يساعدتاريخ البدأ على الحد من حجم تقريرك باظهار التغيرات في الحالة قبل التاريخ الذي اخترته انت |,
		lastUpdated => 1173721345
	},
	...
	'12 description' => {
		message => q|كم من الصفوفمن المفترض امن تعرض قبل ان تقسم الصفحات الى صفحات مختلفة؟ بكلمات اخرى, كم سطر من المفروض ان تظهر في الصفحة الواحدة؟. |,
	...
	'2' => {
		message => q|ادخل واحد في السطر<br />|,
		lastUpdated => 1173721492
	},

	'17' => {
		message => q|تاريخ الانتهاء<br />|,
		lastUpdated => 1173721356
	},
	...
	'1' => {
		message => q|قائمة الحالة<br />|,
		lastUpdated => 1173719999
	},
	...
	'3 description' => {
		message => q|من المجموعات المسموح لها بالاطلاع على التقارير التي تم عملها من وبجيكت لوحة في الداخل/في الخارج؟|,
	...
	'22' => {
		message => q|لوحة في الداخل/في الخارج, نموذج تقرير<br />|,
	...
	'4' => {
		message => q|اعرض التقرير|,
		lastUpdated => 1173721811
	},

	'5' => {
		message => q|الحالة|,
		lastUpdated => 1173721817
	},
