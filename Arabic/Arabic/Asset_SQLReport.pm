...
our $I18N = {
	...
	'Prequery statements' => {
		message => q|تصريحات ما قبل الطلب<br />|,
		lastUpdated => 1164905547
	},
	...
	'72' => {
		message => q|نموذج تقرير اس كيو ال<br />|,
	...
	'Prequery error' => {
		message => q|حدث خطأ ما قبل الطلب<br />|,
	...
	'11' => {
		message => q|خطأ: يوجد مشكلة في الطلب.<br />|,
	...
	'16 description' => {
		message => q|اذا كنت تريد ان تظهر تصحيح الاخطاء و رسائل الخطأ على الصفحة, علم هذا الصندوق.|,
	...
	'12' => {
		message => q|خطأ: لم يتمكن من الوصول الى قاعدة البيانات. |,
