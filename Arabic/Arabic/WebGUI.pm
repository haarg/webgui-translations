...
our $I18N = {
	...
	'127' => {
		message => q|العنوان الالكتروني للشركة<br />|,
		lastUpdated => 1167153343
	},

	'1049' => {
		message => q|هوية فلتر المادة<br />|,
		lastUpdated => 1167150282
	},

	'71' => {
		message => q|استعد كلمة السر<br />|,
		lastUpdated => 1167320126
	},

	'118' => {
		message => q|تسجيل مجهول<br />|,
		lastUpdated => 1167151840
	},

	'443' => {
		message => q|معلومات المنزل<br />|,
		lastUpdated => 1167245137
	},
	...
	'331' => {
		message => q|ولاية العمل<br />|,
		lastUpdated => 1167240937
	},

	'358' => {
		message => q|العمود الايسر<br />|,
		lastUpdated => 1167241803
	},

	'1050' => {
		message => q|ابحث عن<br />|,
		lastUpdated => 1167150306
	},

	'560' => {
		message => q|تم تصديقه<br />|,
		lastUpdated => 1167319241
	},

	'737' => {
		message => q|8 ماستر<br />|,
	...
	'135 description' => {
		message => q|  <p dir="rtl" class="MsoNormal"><span>هذا هو عنوان خادم البريد المحلي. هذا العنوان مطلوب من كل الخواص التي تستخدم نظام الايميل (مثل استرجاع كلمة السر).</span></p>  <p dir="rtl" class="MsoNormal"><span>&nbsp;</span></p>  <p dir="rtl" class="MsoNormal"><span>بالاختيار, إذا كنت تشغل خادم ارسل البريد على نفس الجهاز مثل ويب جوي, من الممكن أن تحدد الطريق من اجل تنفيذ ارسال البريد. على اغلب أنظمة اللينكس من الممكن أن تجد هذا في </span><span>&quot;/usr/lib/sendmail&quot;.</span><span></span></p>  |,
		lastUpdated => 1167239409
	},
	...
	'728' => {
		message => q|هل انت متاكد من انك تريد مسح هذا الملف؟<br />|,
		lastUpdated => 1167320253
	},
	...
	'325' => {
		message => q|الولاية الام<br />|,
		lastUpdated => 1167240879
	},
	...
	'572' => {
		message => q|صدق|,
		lastUpdated => 1167319347
	},

	'350' => {
		message => q|تم اكماله<br />|,
	...
	'58' => {
		message => q|عندي حساب بالفعل|,
		lastUpdated => 1167319383
	},

	'431' => {
		message => q|عنوان الاي بي<br />|,
		lastUpdated => 1167244863
	},

	'527' => {
		message => q|الصفحة الرئيسية الاعتيادية<br />|,
		lastUpdated => 1167318764
	},
	...
	'337' => {
		message => q|<div align="right">العنوان الالكتروني للموقع<br /></div>|,
		lastUpdated => 1167241092
	},

	'76' => {
		message => q|عنوان البريد هذا ليس في قاعدة البيانات الخاصة بنا<br />|,
		lastUpdated => 1167320851
	},

	'340' => {
		message => q|انثى|,
		lastUpdated => 1167241116
	},

	'62' => {
		message => q|احفظ|,
		lastUpdated => 1167319639
	},

	'311' => {
		message => q|اسمح بمعلومات المنزل؟<br />|,
		lastUpdated => 1167240579
	},
	...
	'418' => {
		message => q|فلتر المادة<br />|,
		lastUpdated => 1167244357
	},

	'168' => {
		message => q|عدل المستخدم<br />|,
		lastUpdated => 1167240268
	},

	'706' => {
		message => q|ساعة (ساعات)<br />|,
		lastUpdated => 1167320090
	},

	'14' => {
		message => q|اظهر الطلبات المنتظرة<br />|,
		lastUpdated => 1167239441
	},

	'135' => {
		message => q|SMTP Server|,
		lastUpdated => 1167238234
	},
	...
	'509' => {
		message => q|الشكل الخارجي للنقاش<br />|,
		lastUpdated => 1167318677
	},

	'367' => {
		message => q|انهي وقت المعادلة<br />|,
		lastUpdated => 1167243985
	},

	'8' => {
		message => q|صفحة الاظهار غير موجودة<br />|,
		lastUpdated => 1167320920
	},
	...
	'43' => {
		message => q|هل انت متاكد من انك تريد مسح هذه المادة؟<br />|,
		lastUpdated => 1167244807
	},

	'485' => {
		message => q|Boolean (صندوق اختيارات)<br />|,
		lastUpdated => 1167318297
	},

	'391' => {
		message => q|امسح الملف المرفق|,
		lastUpdated => 1167244174
	},

	'743' => {
		message => q|يجب ان تحدد عنوان بريد يعمل من اجل ان تحاول استعادة كلمة السر<br />|,
		lastUpdated => 1167320565
	},
	...
	'460' => {
		message => q|وقت المعادلة<br />|,
		lastUpdated => 1167245446
	},

	'119' => {
		message => q|طريقة التوثيق<br />|,
		lastUpdated => 1167152711
	},

	'453' => {
		message => q|تاريخ الانشاء<br />|,
		lastUpdated => 1167245297
	},

	'324' => {
		message => q|المدينة الام<br />|,
	...
	'379' => {
		message => q|هوية المجموعة<br />|,
		lastUpdated => 1167244115
	},
	...
	'452' => {
		message => q|من فضلك انتظر...<br />|,
		lastUpdated => 1167245288
	},

	'342' => {
		message => q|عدل معلومات الحساب<br />|,
		lastUpdated => 1167241134
	},
	...
	'438' => {
		message => q|اسمك|,
		lastUpdated => 1167245044
	},

	'107' => {
		message => q|حماية|,
		lastUpdated => 1167150864
	},
	...
	'444' => {
		message => q|معلومات وصف السكان<br />|,
		lastUpdated => 1167245167
	},
	...
	'39' => {
		message => q|ليس لديك الصلاحيات الكافية للطلاع على هذه الصفحة<br />|,
		lastUpdated => 1167244157
	},
	...
	'1004 description' => {
		message => q|  <p dir="rtl" class="MsoNormal"><span>المواقع الكبيرة المستخدمة للبيانات المجمعة ستقوم بعمل الكثير من الاتصالات لقاعدة البيانات الخارجية. لكي تساعد في تقليل الحمل, من الممكن أن تختار إلى أي وقت تريد أن تكيش النتائج الخاصة بقاعدة البيانات الخارجية من خلال قاعدة بيانات الويب جوي. خلفية التكييش الأكثر تقدما من الممكن أن تكون في النسخ الاحدث من الويب جوي</span></p>  |,
		lastUpdated => 1167149816
	},
	...
	'64' => {
		message => q|اخرج|,
		lastUpdated => 1167319689
	},

	'558' => {
		message => q|عدل الكرما للمستخدم<br />|,
		lastUpdated => 1167319128
	},
	...
	'12' => {
		message => q|اغلق الادمين<br />|,
		lastUpdated => 1167152728
	},
	...
	'312' => {
		message => q|اسمح بمعلومات العمل؟<br />|,
		lastUpdated => 1167240595
	},
	...
	'45' => {
		...
		lastUpdated => 1167245209
	},

	'507' => {
		message => q|عدل النموذج<br />|,
		lastUpdated => 1167318662
	},

	'405' => {
		message => q|الصفحة الاخيرة<br />|,
	...
	'1084' => {
		message => q|استخدم شريط الادوات الاعتيادي للغة الخاصة بي<br />|,
		lastUpdated => 1167151620
	},

	'370' => {
		message => q|عدل المجموعات<br />|,
		lastUpdated => 1167244037
	},

	'309' => {
		message => q|اسمح للاسم الحقيقي؟<br />|,
		lastUpdated => 1167240533
	},
	...
	'144' => {
		message => q|اظهر الاحصائيات<br />|,
		lastUpdated => 1167239483
	},
	...
	'824' => {
		message => q|ملحقة البريد<br />|,
		lastUpdated => 1167321784
	},

	'661' => {
		message => q|ضبط الملف, عذل<br />|,
		lastUpdated => 1167319793
	},
	...
	'1075' => {
		message => q|وصلة قاعدة البيانات<br />|,
		lastUpdated => 1167151131
	},
	...
	'581' => {
		message => q|اضف قيمة جديدة<br />|,
		lastUpdated => 1167319393
	},
	...
	'392' => {
		message => q|امسح هذا الملف<br />|,
		lastUpdated => 1167244184
	},
	...
	'496' => {
		message => q|المحرر الذي سيتم استخدامه<br />|,
	...
	'42' => {
		message => q|من فضلك اكد<br />|,
		lastUpdated => 1167244450
	},
	...
	'1073' => {
		message => q|نموذج شكل<br />|,
		lastUpdated => 1167150976
	},

	'436' => {
		message => q|اغلق الجلسة<br />|,
		lastUpdated => 1167244975
	},

	'51' => {
		message => q|كلمة السر<br />|,
		lastUpdated => 1167318685
	},
	...
	'1051 description' => {
		message => q|ماذا تريد ان تستبدل الخيط به<br />|,
		lastUpdated => 1167150363
	},
	...
	'493' => {
		message => q|رجوع الى الموقع<br />|,
		lastUpdated => 1167318603
	},
	...
	'161' => {
		message => q|تم ادخله بـ<br />|,
		lastUpdated => 1167239587
	},

	'582' => {
		message => q|اتركها فارغة<br />|,
		lastUpdated => 1167319406
	},
	...
	'746' => {
		message => q|ضبط ايقونة قائمة الادوات<br />|,
		lastUpdated => 1167320651
	},

	'400' => {
		message => q|امنع ادخال البروكسي في الذاكرة المؤقتة<br />|,
		lastUpdated => 1167244234
	},
	...
	'700' => {
		message => q|يوم(اسام)|,
		lastUpdated => 1167320025
	},

	'475' => {
		message => q|نص|,
		lastUpdated => 1167246085
	},

	'441' => {
		message => q|ارسل الى البيجر<br />|,
		lastUpdated => 1167245121
	},
	...
	'349' => {
		message => q|احدث النسخ الموجودة<br />|,
	...
	'138' => {
		message => q|نعم|,
		lastUpdated => 1167239416
	},

	'751' => {
		message => q|اصبح هذا المستخدم<br />|,
		lastUpdated => 1167320714
	},

	'60' => {
		message => q|هل انت متاكد من انك تريد اغلاق حسابك. اذا استمريت ستمسح معلومات حسابك نهائيا.<br />|,
		lastUpdated => 1167319469
	},
	...
	'724' => {
		message => q|اسم المستخدم الخاص بك لا يمكن ان يبدأ بمسافات او تابات<br />|,
		lastUpdated => 1167320212
	},
	...
	'346' => {
		message => q|هذا المستخدم ليس عضوا في الموقع بعد الان. ليس لدينا ايه معلومات عن هذا المستخدم<br />|,
		lastUpdated => 1167241682
	},
	...
	'323' => {
		message => q|عنوان المنزل<br />|,
		lastUpdated => 1167240861
	},
	...
	'756' => {
		message => q|ارجع قائمة المجموعات|,
		lastUpdated => 1167320823
	},
	...
	'446' => {
		message => q|موقع العمل<br />|,
		lastUpdated => 1167245187
	},
	...
	'352' => {
		message => q|التاريخ|,
		lastUpdated => 1167241749
	},

	'130 description' => {
		message => q|<p dir="rtl" class="MsoNormal"><span>الحجم الاقصى (بالكيلوبايت) للمرفقات المسموحة لكي ترفع على النظام الخاص بك. بناء على طبيعة الـ</span><span> </span><span>HTTP Protocol</span><span>, 100 ميجا بيت هو حجم الملف الأكبر الذي من الممكن أن ترفعه من خلال الواجهة الخاصة بنظام ويب جوي.</span></p>|,
		lastUpdated => 1167238195
	},
	...
	'126' => {
		message => q|عنوان البريد الالكتروني الخاص بالشركة<br />|,
		lastUpdated => 1167153148
	},

	'426' => {
		message => q|تاريخ الدخول<br />|,
		lastUpdated => 1167244755
	},

	'369' => {
		message => q|تاريخ الانتهاء<br />|,
	...
	'810' => {
		message => q|ارسل|,
		lastUpdated => 1167321218
	},

	'372' => {
		message => q|عدل مجموعات المستخدمين<br />|,
		lastUpdated => 1167244096
	},

	'574' => {
		message => q|ارفض|,
		lastUpdated => 1167319355
	},
	...
	'526' => {
		message => q|اخرج الجافا سكريبت و اوقف الماكروهات<br />|,
		lastUpdated => 1167318743
	},

	'72' => {
		message => q|استعد|,
		lastUpdated => 1167320139
	},

	'566' => {
		message => q|عدل وقت الانتهاء<br />|,
		lastUpdated => 1167319313
	},

	'806' => {
		message => q|امسح هذه المجموعة<br />|,
		lastUpdated => 1167321030
	},
	...
	'533' => {
		message => q|من دون الكلمات<br />|,
		lastUpdated => 1167318940
	},

	'359' => {
		message => q|العمود الايمن<br />|,
		lastUpdated => 1167241811
	},
	...
	'1006 description' => {
		message => q|  <p dir="rtl" class="MsoNormal"><span>هل يجب أن يستخدم النظام بروتوكول ال</span><span>HTTPS</span><span> في نموذج الدخول؟ ضع في الاعتبار أن تشغيل هذه الخاصية لن يعدل فقط صفحة الدخول و لكن كل الصفحات التي تتبعها.</span></p>  |,
		lastUpdated => 1167149994
	},
	...
	'462' => {
		message => q|ضبط الوقت<br />|,
		lastUpdated => 1167245492
	},

	'232' => {
		message => q|لا يوجد مادة<br />|,
		lastUpdated => 1167240497
	},

	'477' => {
		message => q|مساحة التش تي ام ال<br />|,
		lastUpdated => 1167246105
	},

	'815' => {
		message => q|الملف الذي حاولت رفعه كبير جدا<br />|,
	...
	'330' => {
		message => q|مدينة العمل<br />|,
		lastUpdated => 1167240929
	},
	...
	'167' => {
		message => q|هل انت متاكد من انك تريد مسح هذا المستخدم؟ ضع في الاعتبار ان كل المعلومات عن هذا المستخدم سوف تفقد الى الابد في حالة الاكمال. |,
	...
	'514' => {
		message => q|مرات الاظهار<br />|,
		lastUpdated => 1167318703
	},

	'725' => {
		message => q|لا يمكن ان يترك اسم المستخدم فارغا<br />|,
		lastUpdated => 1167320231
	},
	...
	'50' => {
		...
		lastUpdated => 1167318636
	},

	'476' => {
		message => q|مساحة النص<br />|,
		lastUpdated => 1167246094
	},
	...
	'1076' => {
		message => q|قاعدة بيانات ويب جوي<br />|,
		lastUpdated => 1167151406
	},

	'510' => {
		message => q|مسطح|,
		lastUpdated => 1167318694
	},

	'1077' => {
		message => q|الخاصية التي تحاول استدعائها غير موجودة في وحدة التوثيق. |,
		lastUpdated => 1167151483
	},

	'449' => {
		message => q|معلومات متنوعة<br />|,
	...
	'353' => {
		message => q|لا يوجد اي رسائل في صندوق بريدك الان<br />|,
		lastUpdated => 1167241766
	},

	'575' => {
		message => q|عدل|,
		lastUpdated => 1167319361
	},
	...
	'1039' => {
		message => q|رجوع|,
		lastUpdated => 1167150183
	},

	'1005' => {
		message => q|طلب اس كيو ال<br />|,
		lastUpdated => 1167149868
	},

	'40' => {
		message => q|مكون اساسي<br />|,
		lastUpdated => 1167244205
	},

	'310' => {
		message => q|اسمح بمعلومات اتصال اكثر؟<br />|,
		lastUpdated => 1167240554
	},
	...
	'130' => {
		message => q|الحد الاقصى لحجم المرفقة|,
		lastUpdated => 1167238051
	},

	'543' => {
		message => q|اضف مجموعة صور جديدة|,
		lastUpdated => 1167319035
	},
	...
	'809' => {
		message => q|ارسل المجموعة<br />|,
		lastUpdated => 1167321119
	},

	'332' => {
		message => q|زيب كود العمل<br />|,
		lastUpdated => 1167240946
	},
	...
	'425' => {
		message => q|الجلسات النشطة<br />|,
		lastUpdated => 1167244741
	},
	...
	'736' => {
		message => q|7 محترف<br />|,
		lastUpdated => 1167320394
	},

	'539' => {
		message => q|شغل الكرما<br />|,
		lastUpdated => 1167318983
	},
	...
	'1004' => {
		message => q|مجموعات الكيش الى اي وقت؟|,
		lastUpdated => 1167147421
	},
	...
	'1045' => {
		message => q|متداخل|,
		lastUpdated => 1167150250
	},

	'532' => {
		message => q|بعلى الاقل واحدة من الكلمات<br />|,
	...
	'1069' => {
		message => q|المضيف الذي سيستخدم<br />|,
	...
	'368' => {
		message => q|اضف مجموعة جديدة الى هذا المستخدم<br />|,
	...
	'316' => {
		message => q|الاسم الاخير|,
		lastUpdated => 1167240802
	},
	...
	'163' => {
		message => q|اضف مستخدم|,
		lastUpdated => 1167239599
	},
	...
	'175' => {
		message => q|قم بعمل الماكروهات؟<br />|,
		lastUpdated => 1167240427
	},
	...
	'35' => {
		message => q|<p>خاصية ادارة&nbsp;<br /></p>|,
		lastUpdated => 1167241727
	},
	...
	'442' => {
		message => q|معلومات العمل<br />|,
		lastUpdated => 1167245129
	},

	'429' => {
		message => q|وقت الدخول<br />|,
		lastUpdated => 1167244776
	},
	...
	'67' => {
		message => q|قم بعمل حساب جديد<br />|,
		lastUpdated => 1167319868
	},

	'812' => {
		message => q|تم ارسال رسالتك<br />|,
		lastUpdated => 1167321291
	},

	'794' => {
		message => q|المجموعات|,
		lastUpdated => 1167320903
	},

	'327' => {
		message => q|البلد الام<br />|,
		lastUpdated => 1167240905
	},

	'320' => {
		message => q|<a href="http://messenger.yahoo.com/">Yahoo! Messenger</a> Id|,
		lastUpdated => 1167240836
	},
	...
	'361' => {
		message => q|ثلاثة على واحد<br />|,
		lastUpdated => 1167243904
	},

	'465' => {
		message => q|حجم صندوق النص<br />|,
		lastUpdated => 1167246077
	},
	...
	'819' => {
		message => q|تم ايقافه ذاتيا<br />|,
		lastUpdated => 1167321668
	},
	...
	'104' => {
		message => q|العنوان الالكتروني<br />|,
		lastUpdated => 1167150196
	},

	'412' => {
		message => q|الملخص|,
		lastUpdated => 1167244346
	},
	...
	'314' => {
		message => q|الاسم الاول|,
		lastUpdated => 1167240783
	},
	...
	'754' => {
		message => q|ادر المستخدمين في هذه المجموعة<br />|,
		lastUpdated => 1167320746
	},
	...
	'159' => {
		message => q|صندوق البريد الوارد<br />|,
		lastUpdated => 1167239567
	},

	'553' => {
		message => q|الحالة|,
		lastUpdated => 1167319077
	},

	'704' => {
		message => q|ثانية (ثواني)|,
	...
	'555' => {
		message => q|عدل الكرما لهذا المستخدم<br />|,
	...
	'37' => {
		message => q|تم رفض السماح<br />|,
		lastUpdated => 1167244025
	},
	...
	'538' => {
		message => q|حد الكرما<br />|,
		lastUpdated => 1167318972
	},
	...
	'74' => {
		message => q|معلومات الحساب<br />|,
		lastUpdated => 1167320441
	},

	'240' => {
		message => q|هوية الرسالة<br />|,
		lastUpdated => 1167240506
	},

	'334' => {
		message => q|هاتف العمل<br />|,
		lastUpdated => 1167240968
	},
	...
	'440' => {
		message => q|معلومات الاتصال<br />|,
		lastUpdated => 1167245104
	},

	'230' => {
		message => q|الرسالة|,
		lastUpdated => 1167240484
	},

	'1008' => {
		message => q|نص و HTML مختلط<br />|,
		lastUpdated => 1167150018
	},

	'1027' => {
		message => q|استخدم فلاتر المادة؟<br />|,
		lastUpdated => 1167150103
	},
	...
	'1072' => {
		message => q|عنوان البريد مستخدم. من فضلك استخدم عنوان اخر<br />|,
		lastUpdated => 1167150966
	},
	...
	'126 description' => {
		message => q|  <p dir="rtl" class="MsoNormal"><span>عنوان بريد الكتروني عام في شركتك. هذا هو البريد الذي ستأتي منه الرسائل. يمكن أن يستخدم من خلال ماكرو الشكل الخاص بعنوان بريد الشركة</span></p>  |,
		lastUpdated => 1167153321
	},
	...
	'701' => {
		message => q|اسبوع (اسابيع)<br />|,
		lastUpdated => 1167320035
	},

	'820' => {
		message => q|لم يتم تشغيل نلفك. و بالتالي لا يمكن ان تدخل على الملف الا اذا تم تشغيله, لا يمكن تشغيله الا عن طريق مدير<br />|,
		lastUpdated => 1167321733
	},

	'174' => {
		message => q|اظهر العنوان؟<br />|,
		lastUpdated => 1167240414
	},

	'481' => {
		message => q|رقم الهاتف<br />|,
		lastUpdated => 1167246137
	},
	...
	'422' => {
		message => q|<p>لم يتم الدخول</p><p>المعلومات الموجودة لا تطابق الحساب&nbsp;</p>|,
		lastUpdated => 1167244596
	},

	'817' => {
		message => q|نشط|,
		lastUpdated => 1167321642
	},

	'563' => {
		message => q|الحالة الاعتيادية<br />|,
	...
	'229' => {
		message => q|مادة|,
		lastUpdated => 1167240459
	},

	'104 description' => {
		message => q|ادخل عنوان الكتروني لهذه الوصلة<br />|,
		lastUpdated => 1167150212
	},
	...
	'315' => {
		message => q|الاسم الوسط<br />|,
		lastUpdated => 1167240792
	},
	...
	'338' => {
		message => q|عدل الملف<br />|,
		lastUpdated => 1167241101
	},

	'576' => {
		message => q|امسح|,
		lastUpdated => 1167319368
	},

	'738' => {
		message => q|9 معلم<br />|,
		lastUpdated => 1167320417
	},
	...
	'484' => {
		message => q|اختر القائمة<br />|,
		lastUpdated => 1167318275
	},

	'1078' => {
		message => q|يوجد مستخدم على هذا النظام بعنوان البريد الذي ادخلته. اضغط &quot;حفظ&quot; اذا مازلت تريد عمل هذا المستخدم.<br />|,
		lastUpdated => 1167151573
	},
	...
	'328' => {
		message => q|هاتف المنزل<br />|,
		lastUpdated => 1167240914
	},
	...
	'1085' => {
		message => q|متغيرات نموذج ترقيم الصفحات<br />|,
	...
	'363' => {
		message => q|موقع نموذج الصفحة<br />|,
		lastUpdated => 1167243930
	},
	...
	'127 description' => {
		message => q|  <p class="&quot;MsoNormal&quot;"><span>العنوان الاساسي لشركتك. سيظهر هذا العنوان في كل الرسائل المرسلة من نظام ويب جوي. هو أيضا متوفر من خلال الماكرو الخاص بالعنوان الالكتروني للشركة.</span></p>  |,
		lastUpdated => 1167239622
	},

	'1051' => {
		message => q|بدل بـ<br />|,
		lastUpdated => 1167150345
	},

	'733' => {
		message => q|4 ماهر<br />|,
		lastUpdated => 1167320359
	},

	'562' => {
		message => q|في الانتظار<br />|,
		lastUpdated => 1167319259
	},
	...
	'748' => {
		message => q|عد المستخدمين<br />|,
		lastUpdated => 1167320665
	},

	'362' => {
		message => q|جانب بجانب<br />|,
		lastUpdated => 1167243915
	},

	'439' => {
		message => q|المعلومات الشخصية<br />|,
		lastUpdated => 1167245072
	},
	...
	'169' => {
		message => q|اضف مستخدم جديد<br />|,
		lastUpdated => 1167240386
	},

	'411' => {
		message => q|عنوان القائمة<br /> |,
		lastUpdated => 1167244332
	},
	...
	'705' => {
		message => q|دقيقة (دقائق)<br />|,
		lastUpdated => 1167320082
	},

	'478' => {
		message => q|العنوان الالكتروني<br />|,
		lastUpdated => 1167246116
	},
	...
	'407' => {
		message => q|انقر هنا لتسجل<br />|,
		lastUpdated => 1167244314
	},

	'537' => {
		message => q|كرما|,
		lastUpdated => 1167318947
	},
	...
	'313' => {
		message => q|اسمح بمعلومات متنوعة؟<br />|,
		lastUpdated => 1167240768
	},
	...
	'551' => {
		message => q|اشعار<br />|,
		lastUpdated => 1167319058
	},

	'529' => {
		message => q|النتائج في الصفحة<br />|,
		lastUpdated => 1167318872
	},

	'229 description' => {
		message => q|مادة الرسالة|,
		lastUpdated => 1167240473
	},
	...
	'753' => {
		message => q|عدل هذه المجموعة<br />|,
		lastUpdated => 1167320728
	},

	'343' => {
		message => q|اظهر الملف<br />|,
		lastUpdated => 1167241643
	},

	'504' => {
		message => q|نموذج|,
		lastUpdated => 1167318652
	},
	...
	'1010' => {
		message => q|نص|,
		lastUpdated => 1167150032
	},

	'707' => {
		message => q|اظهر تصحيح الاخطاء؟|,
		lastUpdated => 1167320115
	},
	...
	'65' => {
		message => q|من فضلك اغلق حسابي نهائيا<br />|,
		lastUpdated => 1167319710
	},
	...
	'1069 description' => {
		message => q|  <p dir="rtl" class="MsoNormal"><span>اختر المضيف الذي سيستخدم اعتياديا عندما يتم عمل العناوين الالكترونية. </span><span>Config Sitename</span><span> سوف يستخدم &quot;اسم الموقع&quot; المتغير من ملف الضبط. مضيف ال</span><span>Env HTTP</span><span> <span>سوف يستخدم متغير البيئة الخاص بالـ&quot;</span></span><span> </span><span>HTTP_HOST</span><span>&quot; و الذي يتم توفيره من خادم الويب.</span></p>  |,
	...
	'729' => {
		message => q|0 يبدأ<br />|,
		lastUpdated => 1167320274
	},

	'2' => {
		message => q|صفحة|,
		lastUpdated => 1167240435
	},

	'435' => {
		message => q|توقيع الجلسة|,
		lastUpdated => 1167244915
	},
	...
	'147' => {
		message => q|الاصول|,
		lastUpdated => 1167239546
	},

	'339' => {
		message => q|ذكر|,
		lastUpdated => 1167241109
	},

	'1046' => {
		message => q|تم ارشفته<br />|,
		lastUpdated => 1167150259
	},
	...
	'531' => {
		message => q|بكل الجمل المحددة<br />|,
		lastUpdated => 1167318916
	},

	'345' => {
		message => q|ليس رقم<br />|,
		lastUpdated => 1167241652
	},

	'319' => {
		message => q|<a href="http://messenger.msn.com/">MSN Messenger</a> Id|,
		lastUpdated => 1167240828
	},
	...
	'735' => {
		message => q|6 خبير<br />|,
		lastUpdated => 1167320387
	},

	'404' => {
		message => q|الصفحة الاولى<br />|,
		lastUpdated => 1167244282
	},
	...
	'1043' => {
		message => q|في بالارشفة بعد<br />|,
		lastUpdated => 1167150224
	},
	...
	'420' => {
		message => q|لا تلغي اي شيء<br />|,
		lastUpdated => 1167244462
	},
	...
	'487' => {
		message => q|اختر صندوقا<br />|,
		lastUpdated => 1167318593
	},

	'1071' => {
		message => q|Env HTTP Host|,
		lastUpdated => 1167150941
	},
	...
	'336' => {
		message => q|تاريخ الميلاد<br />|,
		lastUpdated => 1167241034
	},
	...
	'149' => {
		...
		lastUpdated => 1167239555
	},

	'304' => {
		message => q|اللغة|,
		lastUpdated => 1167240521
	},
	...
	'482' => {
		message => q|الرقم (عدد صحيح)<br />|,
		lastUpdated => 1167318255
	},
	...
	'54' => {
		...
		lastUpdated => 1167319007
	},

	'1030' => {
		message => q|من خلال<br />|,
		lastUpdated => 1167150163
	},
	...
	'70' => {
		message => q|خطأ|,
		lastUpdated => 1167320014
	},

	'1047' => {
		message => q|اضف فلتر مادة<br />|,
		lastUpdated => 1167150268
	},
	...
	'403' => {
		message => q|افضل ان لا اقول<br />|,
		lastUpdated => 1167244269
	},
	...
	'75' => {
		message => q|معلومات الحساب الخاصه بك تم ارسالها الى بريدك<br />|,
		lastUpdated => 1167320687
	},
	...
	'421' => {
		message => q|الغي اي شيء ماعدا الضبط المبدئي<br />|,
		lastUpdated => 1167244489
	},

	'59' => {
		message => q|نسيت كلمة السر<br />|,
		lastUpdated => 1167319431
	},

	'450' => {
		message => q|اسم العمل (اسم الشركة)|,
		lastUpdated => 1167245230
	},
	...
	'1070' => {
		message => q|اضبط اسم الموقع<br />|,
		lastUpdated => 1167150880
	},

	'703' => {
		message => q|سنة (سنين)|,
		lastUpdated => 1167320060
	},
	...
	'146' => {
		message => q|الجلسات الفاعلة<br />|,
		lastUpdated => 1167239538
	},
