...
our $I18N = {
	...
	'dashboard usersGroupId description' => {
		message => q|المجموعة التي يمكنهم حفظ تخصيصاتهم/اولوياتهم على الموقع. اذا كان احد في مجموعة &quot;من يستطيع الاطلاع؟&quot; و ليس في هذه المجموعة, يمكنهم تخصيص ترتيب اعمال اللوحة (سيتم حفظ مواقعهم في الكوكيز), و لكنهم لن يستطيعوا تعديل الاولويات في اي من اعمال اللوحة.<br />|,
		lastUpdated => 1164210477
	},

	'dashboard adminsGroupId field label' => {
		message => q|من الذي يمكنه الادارة؟<br />|,
	...
	'dashboard adminsGroupId description' => {
		message => q|اي مجموعة في امكانها التحكم في لوحة القياس: اضف/عدل/اخرج متوفرة في التحكم, الافضليات, و النماذج.<br />|,
		lastUpdated => 1164209781
	},

	'dashboard template description' => {
		message => q|اختر لوحة تحكم/نموذج للموقع. الشكل المعتاد هوشكل ثلاثة اعمدة.<br />|,
		lastUpdated => 1164209904
	},
