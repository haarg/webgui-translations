...
our $I18N = {
	'history actionTaken' => {
		...
		lastUpdated => 1177166425
	},

	'editLabel' => {
		message => q|عدل|,
		lastUpdated => 1177166379
	},

	'content' => {
		message => q|محتويات هذه الصفحة, بعناوين ملحوظة و الوصلات مغيرة الى Wiki links.|,
	...
	'viewLabel variable' => {
		message => q|علامة دولية للاطلاع على محتويات  هذه الصفحة. مفيدة للـtabbed interfaces  على الـWiki Page|,
	...
	'deleteConfirmation' => {
		message => q|wiki page؟رسالة دولية لتأكيد مسح هذه الـ|,
		lastUpdated => 1177166350
	},

	'history username' => {
		message => q|اسم المستخدم الذي نفذ هذه الصفحة.|,
		lastUpdated => 1177167164
	},
	...
	'history body' => {
		message => q|هذه المتغيرات متوفرة للاستخدام في النموذج لعرض تاريخ التعديلات و التغييرات في صفحة WIKI|,
	...
	'historyLabel variable' => {
		message => q|علامة دولية لتتماشى مع historyUrl.|,
		lastUpdated => 1177167174
	},

	'isProtected' => {
		message => q|علامة تتحقق اذا تم الضبط الصفحة لان تكون محمية.|,
		lastUpdated => 1177167189
	},

	'editContent' => {
		message => q|النموذج المصنوع لتعديل محتوى هذه الصفحة.|,
		lastUpdated => 1177166373
	},
	...
	'contentLabel variable' => {
		message => q|العلامة الدولية لتتماشى مع formContent|,
		lastUpdated => 1177166336
	},
	...
	'deleteLabel' => {
		message => q|امسح|,
		lastUpdated => 1177166355
	},

	'searchUrl' => {
		message => q|الرابط لاخذ المستخدم الى شاشى البحث في الصفحات في هذا الويكي|,
		lastUpdated => 1177167236
	},

	'contentLabel' => {
		message => q|محتوى|,
		lastUpdated => 1177166331
	},

	'formHeader' => {
		message => q|HTML code لبدأ النموذج لنموذج تعديل الصفحة.|,
	...
	'formSubmit' => {
		message => q|زر ادخال بعلامة دولية لادخال التغييرات الى الصفحة. |,
		lastUpdated => 1177166415
	},

	'titleLabel variable' => {
		message => q|العلامة الدولية لتستخدم مع formTitle|,
	...
	'canAdminister' => {
		message => q|علامة ستتحققاذا كان المستخدم في المجموعة التي لها صلاحيات ادارية الى الويكي الحاوي لهذه الصفحة.|,
	...
	'views' => {
		message => q| عدد المرات التي تم الاطلاع فيها على هذه الـWikiPage |,
		lastUpdated => 1177167427
	},

	'wikiHomeLabel variable' => {
		message => q|علامة دولية لتستخدم مع wikiHomeUrl|,
	...
	'searchLabel variable' => {
		message => q|علامة دولية لتستخدم مع searchUrl|,
	...
	'formTitle' => {
		message => q|كود اتش تي ام ال لنموذج لادخال او تغيير عنوان الصفحة.|,
	...
	'mostPopularUrl' => {
		message => q|الرابط لاخذ المستخدم الى الشاشة حيث توجد قائمة باكثر الصفحات شهرة.|,
		lastUpdated => 1177167198
	},

	'add/edit title' => {
		message => q|نموذج اضف/عدل Wiki Page |,
	...
	'formContent' => {
		message => q|HTML code لنموذج لادخال او تغيير محتوى هذه الصفحة|,
	...
	'editLabel variable' => {
		message => q|tabbed interfaces الـعلامة دولية للتعديل لمحتوى هذه الصفحة. مفيد للـ للـWiki Page|,
	...
	'history title' => {
		message => q|Wiki Page, نموذج عرض التاريخ|,
		lastUpdated => 1177167154
	},

	'actionTaken' => {
		message => q|الحركة التي تم عملها لانتاج النسخة الحالية من WikiPage. على الجديدة تماما, سيكون ها "Created", ما دون ذلك سيكون "Edited".|,
		lastUpdated => 1177166281
	},
