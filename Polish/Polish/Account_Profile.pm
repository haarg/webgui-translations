package WebGUI::i18n::Polish::Account_Profile;
use utf8;
our $I18N = {
  'back label' => {
    'lastUpdated' => '1238078420',
    'message' => 'Powrót do serwisu'
  },
  'back to profile label' => {
    'lastUpdated' => '1238078430',
    'message' => 'Powrót do profilu'
  },
  'edit my profile' => {
    'lastUpdated' => '1238078440',
    'message' => 'Edytuj swój profil'
  },
  'error label' => {
    'lastUpdated' => '1238078448',
    'message' => "B\x{142}\x{105}d"
  },
  'friends only' => {
    'lastUpdated' => '1238078975',
    'message' => 'Twój profil jest widoczny dla znajomych'
  },
  'friends only label' => {
    'lastUpdated' => '1238078504',
  ...
  'private profile' => {
    'lastUpdated' => '1238078636',
    'message' => 'Twój profil jest prywatny'
  },
  'profile as others label' => {
    'lastUpdated' => '1238078684',
  ...
  'view my profile' => {
    'lastUpdated' => '1227968272',
    'message' => "wy\x{15b}wietl m\x{f3}j profil"
  },
  'visitor profile restricted' => {
    'lastUpdated' => '1238078756',
    'message' => "Profil go\x{15b}cia jest ograniczony"
  }
}
;
