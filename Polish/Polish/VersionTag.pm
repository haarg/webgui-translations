...
our $I18N = {
  ...
  'approval message help' => {
    ...
    'lastUpdated' => '1237846400',
    'message' => "Wprowad\x{17a} wiadomo\x{15b}\x{107}, kt\x{f3}ra ma by\x{107} wys\x{142}ana razem z linkiem zatwierdzenia i danymi przywieszki do os\x{f3}b zatwierdzaj\x{105}cych."
  },
  'approve' => {
