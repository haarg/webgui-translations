...
our $I18N = {
	...
	'title' => {
		message => q|Domyślny tytuł strony.|,
		lastUpdated => 1204205178
	},
	...
	'11' => {
		message => q|Nie określono elementu DN do połączenia dla tego użytkownika|,
		lastUpdated => 1204204959
	},
	...
	'2' => {
		message => q|Brak połączenia z serwerem LDAP.|,
		lastUpdated => 1204205043
	},
	...
	'5' => {
		message => q|LDAP URL (domyślny)|,
		lastUpdated => 1204205087
	},
	...
	'10' => {
		message => q|Hasło (powtórz)|,
		lastUpdated => 1204204916
	},
	...
	'12' => {
		message => q|Nie określono LDAP Url dla tego użytkownika|,
		lastUpdated => 1204204987
	},
	...
	'displayTitle' => {
		message => q|Tytuł strony.|,
		lastUpdated => 1204205195
	},
	...
	'1' => {
		message => q|Opcje Autentykacji LDAP|,
		lastUpdated => 1204204900
	},
	...
	'13' => {
		message => q|Niepoprawny adres URL połączenia LDAP. Skontaktuj sie z administratorem.|,
		lastUpdated => 1204205013
	},
	...
	'6' => {
		message => q|Identyfikator LDAP (domyślny)|,
		lastUpdated => 1204205115
	},
	...
	'4' => {
		message => q|DN dla połączenia|,
		lastUpdated => 1204205074
	},
