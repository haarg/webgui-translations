...
our $I18N = {
  ...
  'export information' => {
    ...
    'message' => '<p>%d Seiten in %d Sekunden exportiert.</p>'
  },
  'controls' => {
  ...
  '872' => {
    ...
    'message' => 'Wer kann das Asset sehen?'
  },
  ...
  'promote help' => {
    ...
    'message' => 'Dieses Asset auf der Seite um eine Position nach oben verschieben.'
  },
  'properties' => {
    'lastUpdated' => 1153263330,
  ...
  'title' => {
    ...
    'message' => 'Titel des Assets'
  },
  'page indicator' => {
    'lastUpdated' => 1217254183,
    'message' => 'Zeige Seite %s von %s'
  },
  'revised by' => {
    'lastUpdated' => 1153262068,
    'message' => 'Versioniert von'
  },
  '11' => {
  ...
  'could not open path' => {
    ...
    'message' => '%-s konnte wegen %-s nicht angelegt werden.'
  },
  'Edit Metadata' => {
  ...
  'rootUrl symlinking default' => {
    ...
    'message' => 'Symlinking extras und uploads Verzeichnis.'
  },
  'assets' => {
  ...
  'make asset exportable description' => {
    'lastUpdated' => 1217254158,
    'message' => '<p>Darf dieses Asset als statisches HTML exportiert werden? Dieses Asset und alle sein Vorg&auml;nger m&uuml;ssen exportierbar sein, damit dieses Asset exportiert werden kann. Ausserdem muss das Exportieren in der WebGUI Konfigurationsdatei aktiviert sein.</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p>'
  },
  'manage help' => {
    'lastUpdated' => 1170458775,
    'message' => 'Ruft den Asset Manager auf und zeigt das aktuelle Asset und evtl. Kinder an.'
  },
  '1079' => {
    'lastUpdated' => 1153126758,
    'message' => 'Style Druckversion'
  },
  ...
  'restore' => {
    'lastUpdated' => 1153262080,
    'message' => 'Wiederherstellen'
  },
  'does asset inherit URL from parent description' => {
    'lastUpdated' => 1217253998,
    'message' => 'Soll der URL dieses Assets die URL des Elternassets vorangestellt werden?'
  },
  ...
  'synopsis' => {
    ...
    'message' => 'Kurze Beschreibung des Inhalts des Assets.'
  },
  'extraHeadTags' => {
  ...
  'Export as user' => {
    ...
    'message' => 'Exportieren als Benutzer'
  },
  'revisions help' => {
    'lastUpdated' => 1153262034,
    'message' => 'Eine Liste aller Versionen dieses Assets anzeigen.<br />'
  },
  'asset list title' => {
  ...
  'asset template asset var title' => {
    ...
    'message' => 'Asset Template Asset Variablen'
  },
  '1082' => {
  ...
  'isPackage' => {
    ...
    'message' => 'Boolscher Wert, der wahr ist, wenn das Asset ein Paket ist.'
  },
  'rootUrl form option symlinkDefault' => {
    'lastUpdated' => 1170451334,
    'message' => 'Symlink Standardwert.'
  },
  ...
  'purge old trash' => {
    ...
    'message' => 'Alten Abfall entfernen'
  },
  ...
  'groupIdEdit' => {
    ...
    'message' => 'Die ID der Gruppe, die das Asset editieren darf.'
  },
  'Class Icon help' => {
...
Dies bedeutet in der Regel, dass Sie eine Seite anlegen m&ouml;chtgen, die den selben Namen wie der Ordner hat.'
  ...
  'could not create' => {
    ...
    'message' => '%s konnte nicht erzeugt werden: %s'
  },
  'purge trash after' => {
  ...
  'manage' => {
    'lastUpdated' => 1153261587,
    'message' => 'Verwalten'
  },
  'none' => {
    'lastUpdated' => 1153262099,
    'message' => 'Nichts'
  },
  ...
  'duplicateField' => {
    ...
    'message' => '<p><strong>Fehler: Feldname &quot;%field%&quot; wird bereits benutzt.</strong></p>'
  },
  '108 description' => {
  ...
  'edit branch' => {
    ...
    'message' => 'Zweig bearbeiten'
  },
  'make prototype description' => {
    'lastUpdated' => 1154467385,
    'message' => '<p>Dieses Asset als Inhalts-Prototyp definieren, so dass es auf Ihrer Site von anderen eingesetzt werden kann.</p>'
  },
  ...
  'package extract error' => {
    ...
    'message' => 'Fehler beim auspacken des Pakets'
  },
  'prototype using title' => {
    'lastUpdated' => 1153263257,
    'message' => 'Inhalts-Prototypen, Verwendung'
  },
  'encryptPage' => {
  ...
  'revision date' => {
    'lastUpdated' => 1153262046,
    'message' => 'Versionsdatum'
  },
  'specified base' => {
  ...
  'asset template title' => {
    ...
    'message' => 'Asset Template Variablen'
  },
  'demote help' => {
  ...
  'extrasUploads form label' => {
    ...
    'message' => 'Extras und uploads Verzeichnisse'
  },
  'does asset inherit URL from parent' => {
    'lastUpdated' => 1217253965,
    'message' => 'Eltern URL voranstellen?'
  },
  'done' => {
  ...
  'ownerUserId' => {
    ...
    'message' => 'Die ID des Benutzers, der das Asset besitzt.'
  },
  'could not symlink' => {
    'lastUpdated' => 1168956612,
    'message' => 'Symlink von %s nach %s konnte nicht erzeugt werden: %s'
  },
  'content profiling' => {
    'lastUpdated' => 1153243725,
    'message' => 'Inhalt profilieren'
  },
  '965' => {
  ...
  'errorEmptyField' => {
    ...
    'message' => '<p><strong>Fehler: Feldname darf nicht leer sein.</strong></p>'
  },
  ...
  'bad user privileges' => {
    ...
    'message' => 'Der Benutzer hat keine Berechtigung, diese Seite zu betrachten.'
  },
  ...
  'groupIdView' => {
    ...
    'message' => 'Die ID der Gruppe, die das Asset betrachten darf.'
  },
  'Depth description' => {
    'lastUpdated' => 1170453740,
    'message' => '<p>Definiert die Tiefe, bis zu welcher der Seitenbaum exportiert werden soll. Bei einem Wert von 0 wird nur die aktuelle Seite exportiert.</p>'
  },
  ...
  'menuTitle' => {
    ...
    'message' => 'Der Titel des Assets, der in der Navigation angezeigt wird.'
  },
  'make prototype' => {
    'lastUpdated' => 1170458719,
    'message' => 'Prototyp erstellen?'
  },
  'topicName' => {
  ...
  'exporting page' => {
    'lastUpdated' => 1153261911,
    'message' => 'Seite %-s wird exportiert......'
  },
  '872 description' => {
