...
our $I18N = {
	...
	'959' => {
		message => q|System-Zwischenablage l&ouml;schen.|,
	...
	'revised by' => {
		message => q|Versioniert von|,
		lastUpdated => 1153262068
	},

	'11' => {
		message => q|M&uuml;lleimer leeren.|,
		lastUpdated => 1153126936
	},

	'could not open path' => {
		message => q|%-s konnte wegen %-s nicht angelegt werden.|,
	...
	'revisions help' => {
		message => q|Eine Liste aller Versionen dieses Assets anzeigen.<br />|,
...
Dies bedeutet in der REgel, dass Sie eine seite anlegen möchtgen, die den selben Namen wie der Ordner hat.|,
	...
	'select all' => {
		message => q|Alles ausw&auml;hlen|,
...
Normalerweise müßten Sie den URL in der letzen Revision des Assets ändern und dann jede Revision des alten Assets bereinigen (weil die alten Revisionen des alten Assets den selben URL besitzen). Die Funktion "URL ändern" erleichert Ihnen diese Arbeit: geben Sie den neuen URL für das alte Asset ein und die Arbeit wird erledigt.|,
	...
	'940 description' => {
		message => q|<p>W&auml;hlen Sie &quot;Ja&quot;, um dieses Asset in einem neuen Browserfenster zu &ouml;ffnen.</p><p>Achtung: Dies kann unter Umst&auml;nden zu diversen Problemen f&uuml;hren. Insbesondere kann es bei einigen Navigationstypen zu Fehler f&uuml;hren, ebenso wenn der Benutzer JavaScript ausgeschaltet hat oder beim Einsatz von Pop-Up-Blockern.</p>|,
	...
	'demote help' => {
		message => q|Dieses Asset auf der Seite um eine Position nach unten verschieben.|,
	...
	'exporting page' => {
		message => q|Seite %-s wird exportiert......|,
