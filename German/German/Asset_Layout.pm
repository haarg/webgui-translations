...
our $I18N = {
  ...
  'assetsToHide' => {
    ...
    'message' => 'Die IDs der Assets, die in diesem Asset nicht gezeigt werden sollen. Getrennt durch Unix-Style Zeilenvorschubzeichen.'
  },
  'content' => {
  ...
  'id' => {
    ...
    'message' => 'Die Asset ID dieses Assets.'
  },
  'isUncommitted' => {
    'lastUpdated' => '1217316368',
    'message' => 'Ein Wahrheitswert, der anzeigt, ob das Asset committed wurde oder nicht'
  },
  ...
  'layout asset template variables title' => {
    ...
    'message' => 'Seitenlayout Template Variablen'
  },
  ...
  'layout template title' => {
    ...
    'message' => 'Seitenlayout Template'
  },
  'mobileTemplateId description' => {
    'lastUpdated' => '1247818914',
    'message' => 'Wähle dieses Template, wenn dieses Seitenlayout in einem Mobile Browser betrachtet wird.'
  },
  'mobileTemplateId label' => {
    'lastUpdated' => '1247818859',
  ...
  'showAdmin' => {
    ...
    'message' => 'Bedingung, die angibt, ob sich der aktuelle Benutzer im Admin Modus befindet und dieses Asset bearbeiten kann.'
  },
