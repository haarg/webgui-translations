...
uid=jdoe,ou=people,dc=example,dc=com'
  ...
  'ldap identity blank' => {
    ...
    'message' => 'Das LDAP Identität Feld darf nicht leer sein.'
  },
  'ldap identity name blank' => {
    'lastUpdated' => 1178632863,
    'message' => 'Das LDAP Identitätsname Feld darf nicht leer sein.'
  },
  ...
  'ldap url malformed' => {
    ...
    'message' => 'LDAP URL hab falsche Form. LDAP URLs müssen das Protokoll enthalten, z.B. ldap://hostname/'
  },
  'ldap user rdn blank' => {
