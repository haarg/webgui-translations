...
our $I18N = {
  ...
  'helpvar searchForm_location' => {
    'lastUpdated' => '1275484827',
    'message' => 'Suche nach Ort'
  },
  ...
  'imageDensity description' => {
    ...
    'message' => 'Die Pixeldichte des Bildes. Bilder in Druckqualität sind mehr als drei mal größer wie Bilder in Bildschirmqualität.'
  },
  'imageDensity label' => {
