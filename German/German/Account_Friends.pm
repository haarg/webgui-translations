...
our $I18N = {
  ...
  'friends layout template hoverHelp' => {
    ...
    'message' => 'Wählen Sie eine Vorlage zur Anzeige der Konten-Plugins, welche vom gegenwärtigen Benutzer bearbeitet werden können sowie zur Anzeige des Inhalts des gegenwärtig gewählten Plugins!'
  },
  'friends layout template label' => {
    'lastUpdated' => '1236435695',
    'message' => 'Layout'
  },
