package WebGUI::i18n::German::Account_Friends;
use utf8;
our $I18N = {
  ...
  'adding user message' => {
    ...
    'message' => "Sie f\x{fc}gen %s zu Ihrem Netzwerk hinzu."
  },
  'back label' => {
    'lastUpdated' => 1229283431,
    'message' => 'Zurück zur Seite'
  },
  'back to profile label' => {
    'lastUpdated' => 1229283444,
    'message' => "Zur\x{fc}ck zum Profil"
  },
  'back to user profile' => {
    'lastUpdated' => 1229283461,
    'message' => 'Zurück zum Benutzerprofil'
  },
  'cancel button label' => {
    'lastUpdated' => 1228754336,
    'message' => 'Abbrechen'
  },
  ...
  'friends confirm template hoverHelp' => {
    ...
    'message' => 'Wählen Sie eine Schablone für die Bestätigung, dass eine Einladung in das Freunde-Netzwerk versandt wurde!'
  },
  'friends confirm template label' => {
    'lastUpdated' => 1229281323,
    'message' => 'Versandbestätigungs-Schablone'
  },
  'friends edit template hoverHelp' => {
    'lastUpdated' => 1229283719,
    'message' => "W\x{e4}hlen Sie die Schablone zur Bearbeitung Ihrer Freunde!"
  },
  ...
  'friends error template hoverHelp' => {
    ...
    'message' => 'Wählen Sie eine Schablone zur Anzeige von Fehlermeldungen!'
  },
  ...
  'friends is off' => {
    ...
    'message' => "Die Freunde-Funktion ist nicht aktiviert. Um diese Seite sehen zu k\x{f6}nnen, m\x{fc}ssen Sie in ihrem Profil die Freunde-Funktion aktivieren."
  },
  'friends layout template hoverHelp' => {
    'lastUpdated' => 1229283738,
    'message' => 'Wählen Sie eine Schablone zur Anzeige der Konten-Plugins, welche vom gegenwärtigen Benutzer bearbeitet werden können sowie zur Anzeige des Inhalts des gegenwärtig gewählten Plugins!'
  },
  ...
  'friends remove confirm template hoverHelp' => {
    ...
    'message' => "W\x{e4}hlen Sie eine Schablone zur Anzeige von Best\x{e4}tigungsmeldungen f\x{fc}r die Entfernung eines Freundes."
  },
  'friends remove confirm template label' => {
    'lastUpdated' => 1229280839,
    'message' => 'Entfernungsbestätigungs-Schablone'
  },
  'friends send request template hoverHelp' => {
    'lastUpdated' => 1229282684,
    'message' => 'Wählen Sie die Schablone für den Versand von Freundschaftsanfragen!'
  },
  ...
  'friends style template hoverHelp' => {
    ...
    'message' => 'Wählen Sie eine Stil-Schablone für die Darstellung der umgebenden Seite!'
  },
  ...
  'friends view template hoverHelp' => {
    ...
    'message' => "W\x{e4}hlen Sie die prim\x{e4}re Schablone zur Darstellung von Freunden!"
  },
  ...
  'no friend selected' => {
    'lastUpdated' => 1229283995,
    'message' => "Sieh haben keinen Freund zum L\x{f6}schen von Ihrer Freundeliste ausgew\x{e4}hlt."
  },
  'not a friend error' => {
    'lastUpdated' => 1229283692,
    'message' => "Der zum L\x{f6}schen ausgew\x{e4}hlte Benutzer ist nicht in der Liste Ihrer Freunde."
  },
  ...
  'remove confirm no' => {
    ...
    'message' => 'Nein, ich habe mich geirrt.'
  },
  'remove confirm yes' => {
    'lastUpdated' => 1229283478,
    'message' => "Ja, diesen Benutzer l\x{f6}schen."
  },
