...
our $I18N = {
  ...
  '77' => {
    ...
    'message' => '<p>Dieser Benutzername ist bereits vergeben. Bitte w&auml;hlen Sie einen anderen Benutzernamen. Im folgenden ein paar Vorschl&auml;ge:<br />%sToo<br />%s2<br />%s_%d<br /></p>'
  },
  '444' => {
