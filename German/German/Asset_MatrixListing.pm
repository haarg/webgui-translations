package WebGUI::i18n::German::Asset_MatrixListing;
use utf8;
our $I18N = {
  ...
  'compares' => {
    ...
    'message' => 'Anzahl der Vergleiche mit dieser Liste.'
  },
  'contact maintainer label' => {
    'lastUpdated' => '1246484176',
    'message' => 'Verwalter kontaktieren'
  },
  'count label' => {
    'lastUpdated' => '1236959869',
    'message' => 'Anzahl'
  },
  'description' => {
  ...
  'label' => {
    ...
    'message' => 'Das Label zu diesem Attribut'
  },
  'last updated label' => {
