...
our $I18N = {
	...
	'questionsPerPage' => {
		message => q|Anzahl der Fragen, die auf einer Seite angezeigt werden.|,
	...
	'groupToViewReports' => {
		message => q|Die ID der Gruppe, die die Reports der Umfrage ansehen darf.|,
	...
	'84' => {
		message => q|Maximale Benutzerantworten pro Benutzer.|,
		lastUpdated => 1178876433
	},

	'57' => {
		message => q|Kommentare|,
	...
	'response.user.name' => {
		message => q|Der Benutzername des Benutzers, der die Benutzerantwort gegeben hat.|,
	...
	'survey.noprivs.label' => {
		message => q|Eine Nachricht, die dem Benutzer anzeigt, dass er nicht die notwendigen Rechte besitzt, um an dieser Umfrage teilzunehmen.|,
	...
	'question.edit.question' => {
		message => q|Die zu bearbeitende Frage.|,
	...
	'templateId' => {
		message => q|Die ID des Templates, das zur Anzeige der Umfrage benutzt wird.|,
		lastUpdated => 1179741903
	},

	'form.footer' => {
		message => q|Erforderliche Formularelemente, die nach den Fragen der Umfrage angezeigt werden.|,
	...
	'47' => {
		message => q|Sie haben das Quiz beendet.|,
	...
	'mode' => {
		message => q|Der Modus der Umfrage. Entweder "Umfrage" oder "Quiz".|,
	...
	'comment.label' => {
		message => q|Das internationalisierte Wort "Comments".|,
	...
	'groupToTakeSurvey' => {
		message => q|Die ID der Gruppe, die an der Umfrage teilnehmen darf.|,
		lastUpdated => 1179732338
	},

	'survey asset template variables title' => {
		message => q|Umfrage Asset Template Variablen|,
		lastUpdated => 1179741769
	},

	'19 description' => {
		message => q|Die Antwort auf diese Frage.|,
	...
	'response template description' => {
		message => q|Dieses Template wird zur Anzeige der Fragen und Antworten benutzt.|,
	...
	'87' => {
		message => q|Klicken Sie hier, um eine neue Benutzerantwort zu starten.|,
	...
	'mode.isSurvey' => {
		message => q|Bedingung, die anzeigt, ob "Umfrage"- oder "Quiz"-Modus eingestellt ist.|,
	...
	'question.answer' => {
		message => q|Die richtige Antwort auf diese Frage.|,
		lastUpdated => 1179733459
	},

	'39' => {
		message => q|Nicht anwendbar|,
	...
	'64' => {
		message => q|Benutzerantworten exportieren.|,
		lastUpdated => 1178875376
	},

	'1089' => {
		message => q|Umfrage Antwort Template|,
		lastUpdated => 1178870381
	},

	'12' => {
		message => q|Wer darf an der Umfrage teilnehmen?|,
	...
	'defaultSectionId' => {
		message => q|Die ID des Standardabschnitts.|,
	...
	'answer.label' => {
		message => q|Das internationalisierte Wort "Answer". Falls die Umfrage nicht im Quiz Modus ist, so ist dieses Label leer.|,
	...
	'response.count.correct' => {
		message => q|Gesamtanzahl an Fragen, die dieser Benutzer korrekt beantwortet hat.|,
	...
	'response.percent' => {
		message => q|Der prozentuale Anteil an korrekt beantworteten Fragen.|,
	...
	'22' => {
		message => q|Antwort Typ|,
		lastUpdated => 1178871448
	},

	'42' => {
		message => q|Gelegentlich|,
	...
	'question' => {
		message => q|Die Frage selbst.|,
		lastUpdated => 1179732907
	},

	'show.responses.label' => {
		message => q|Das Standard Label, das Benutzerantworten anzeigt.|,
	...
	'duration.minutes' => {
		message => q|Dauer bis zur Beendigung der Umfrage in Minuten.|,
		lastUpdated => 1178877330
	},

	'questions.correct.count' => {
		message => q|Die Anzahl der richtig beantworteten Quiz Fragen des Benutzers zu diesem Zeitpunkt.|,
		lastUpdated => 1179737950
	},

	'85 description' => {
		message => q|Die Anzahl der Fragen, die jedem Benutzer gestellt werden.|,
		lastUpdated => 1178876522
	},

	'18' => {
		message => q|Antwort bearbeiten|,
		lastUpdated => 1178871272
	},

	'question.count' => {
		message => q|Die Anzahl der Frage dieser Umfrage.|,
		lastUpdated => 1179733595
	},

	'13 description' => {
		message => q|Wer darf die Ergebnise einer Umfrage anschauen?|,
	...
	'form.header' => {
		message => q|Erforderliche Formularelemente, die vor den Frage der Umfrage angezeigt werden.|,
	...
	'question.comment' => {
		message => q|Der Kommentar des Benutzers zu dieser Frage (falls existent).|,
		lastUpdated => 1179733514
	},

	'20' => {
		message => q|Ist diese Antwort korrekt?|,
	...
	'user.canRespondAgain' => {
		message => q|Bedingung, die anzeigt, ob der Benutzer an der Umfrage zum wiederholten Male teilnehmen darf.|,
	...
	'question.allowComment' => {
		message => q|Bedingung, die anzeigt, ob diese Frage einen Kommentar erlaubt oder nicht.|,
	...
	'65' => {
		message => q|Zusammenfassung exportieren.|,
		lastUpdated => 1178875445
	},

	'user.canTakeSurvey' => {
		message => q|Bedingung, die anzeigt, ob der aktuelle Benutzer die notwendigen Rechte besitzt, um an der Umfrage teilzunehmen.|,
		lastUpdated => 1179742096
	},

	'maxResponsesPerUser' => {
		message => q|Wie oft darf ein Benutzer auf eine einzelne Frage eine Antwort geben (Anzahl Fehlversuche pro Antwort). Standard ist 1.|,
		lastUpdated => 1179732485
	},

	'81' => {
		message => q|Anonyme Benutzerantwort?|,
	...
	'86' => {
		message => q|Fortschritt|,
		lastUpdated => 1178876533
	},

	'2' => {
		message => q|Umfrage bearbeiten|,
	...
	'question.question' => {
		message => q|Die Frage der Umfrage selbst.|,
		lastUpdated => 1179737577
	},

	'82' => {
		message => q|Umfrage beenden|,
		lastUpdated => 1178876382
	},

	'start.date.epoch' => {
		message => q|Datum, an dem der Benutzer die Benutzerantwort begonnen hat, im &quot;epoch&quot; Format.|,
		lastUpdated => 1179741551
	},

	'questions.total' => {
		message => q|Gesamtanzahl der Fragen der Umfrage.|,
	...
	'show.comments.label' => {
		message => q|Das Standard Label, das Kommentare anzeigt.|,
	...
	'questions.correct.percent' => {
		message => q|Der prozentuale Anteil korrekt beantworteter Quiz Fragen des Benutzers zu diesem Zeitpunkt.|,
		lastUpdated => 1179737940
	},

	'view template description' => {
		message => q|Dieses Template wird benutzt, um die Umfrage selbst anzuzeigen.|,
		lastUpdated => 1179742206
	},

	'user.canViewReports' => {
		message => q|Bedingung, die anzeigt, ob der Benutzer die notwendigen Rechte besitzt, um Umfrage Reports anzusehen.|,
	...
	'response template' => {
		message => q|Benutzerantwort Template|,
		lastUpdated => 1179740728
	},

	'14 description' => {
		message => q|Dies ist die Frage, die dem Benutzer gestellt wird.|,
	...
	'33' => {
		message => q|Stimme voll zu|,
		lastUpdated => 1178874690
	},

	'63' => {
		message => q|Fragen exportieren.|,
		lastUpdated => 1178875352
	},

	'7' => {
		message => q|Je nach Benutzerantwort|,
	...
	'end.date.epoch' => {
		message => q|Datum, an dem der Benutzer die Benutzerantwort abgeschlossen hat, im &quot;epoch&quot; Format.|,
		lastUpdated => 1179731527
	},

	'response.label' => {
		message => q|Das internationalisierte Wort "Responses".|,
	...
	'83 description' => {
		message => q|Die Anzahl der Fragen, die pro Seite angezeigt werden. Standard ist eine Frage pro Seite.|,
	...
	'start.time.human' => {
		message => q|Zeitpunkt, an dem der Benutzer die Benutzerantwort begonnen hat, im &quot;human-readable&quot; Format.|,
	...
	'Survey_id' => {
		message => q|Die eindeutige ID dieser Umfrage. Diese ist nicht die gleiche wied die Asset ID.|,
	...
	'48' => {
		message => q|Sie sind zur Zeit nicht berechtigt, an dieser Umfrage teilzunehmen.|,
		lastUpdated => 1178875090
	},

	'questionOrder' => {
		message => q|Definiert die Reihenfolge der Fragen dieser Umfrage. Entweder "sequential", "random", "response" oder "section".|,
	...
	'question.isCorrect' => {
		message => q|Bedingung, die anzeigt, ob der Benutzer die Frage richtig beantwortet hat.|,
	...
	'questions.sofar.count' => {
		message => q|Die Anzahl beantworteter Umfrage Fragen zu diesem Zeitpunkt.|,
		lastUpdated => 1179737928
	},

	'question.isRadioList' => {
		message => q|Bedingung, die anzeigt, ob die Antworten der Frage in einer Radio Liste angezeigt werden.|,
		lastUpdated => 1179737562
	},

	'70' => {
		message => q|Individuelle Benutzerantworten|,
		lastUpdated => 1178875557
	},

	'question.response.total' => {
		message => q|Gesamtanzahl der Benutzerantworten dieser Antwort.|,
	...
	'end.time.human' => {
		message => q|Zeitpunkt, an dem der Benutzer die Benutzerantwort abgeschlossen hat, im "human readable" Format.|,
	...
	'75' => {
		message => q|Diese Frage bearbeiten.|,
	...
	'duration.seconds' => {
		message => q|Die Sekunden von duration.minutes. (z.B. 10min5sek: duration.minutes -> 10; duration.seconds -> 5)|,
		lastUpdated => 1178877429
	},

	'anonymous' => {
		message => q|Boolsche Variable, die zeigt, ob diese Umfrage anonym ist oder nicht.|,
	...
	'13' => {
		message => q|Wer darf Reports ansehen?|,
	...
	'85' => {
		message => q|Fragen pro Benutzerantwort|,
	...
	'response.isComplete' => {
		message => q|Bedingung, die anzeigt, ob der Benutzer in dieser Benutzerantwort alle Fragen dieser Umfrage beantwortet hat.|,
		lastUpdated => 1179740952
	},

	'38' => {
		message => q|Stimme voll nicht zu|,
