...
our $I18N = {
	...
	'in out board asset template variables title' => {
		message => q|In/Out Board Asset Template Variablen|,
		lastUpdated => 1180085273
	},
	...
	'12 description' => {
		message => q|Wie viele Zeilen sollen dargestellt werden bevor die Resultate auf einzelne Seiten aufgeteilt werden? Anders formuliert, wie viele Zeilen/Reihen sollen auf einer Seite dargestellt werden?|,
	...
	'updatedBy label' => {
		message => q|Aktualisiert von|,
		lastUpdated => 1180086673
	},

	'report title' => {
		message => q|In/Out Board Report|,
		lastUpdated => 1180085786
	},
	...
	'deptHasChanged' => {
		message => q|Bedingung, die angibt, ob diese Datenreihe eine andere Abteilung hat als die vorherigen Datenreihen.|,
		lastUpdated => 1180084958
	},

	'view report label' => {
		message => q|Report anschauen|,
		lastUpdated => 1180086869
	},
	...
	'1' => {
		message => q|Statusliste|,
		lastUpdated => 1157856248
	},

	'message label' => {
		message => q|Nachricht|,
		lastUpdated => 1180085576
	},

	'In Out Template' => {
		message => q|In/Out Template|,
		lastUpdated => 1180084572
	},
	...
	'delegate' => {
		message => q|Status aktualisieren von:|,
		lastUpdated => 1180084811
	},
	...
	'showReport' => {
		message => q|Boolscher Wert, der angibt, ob die Variable <em>rows_loop</em> gesetzt wird.|,
		lastUpdated => 1180086286
	},

	'filter departments' => {
		message => q|Filter Abteilungen:|,
		lastUpdated => 1180085022
	},

	'displayForm' => {
		message => q|Boolsche Variable, die angibt, ob die <em>form</em> Variable gesetzt wird oder nicht.|,
		lastUpdated => 1180085008
	},
	...
	'myself' => {
		message => q|Ich selbst|,
		lastUpdated => 1180085616
	},
	...
	'8' => {
		message => q|Status Protokoll Report|,
		lastUpdated => 1180084543
	},

	'4' => {
		message => q|Report ansehen|,
		lastUpdated => 1180084366
	},

	'5' => {
		message => q|Status|,
		lastUpdated => 1180084372
	},
