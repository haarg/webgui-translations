...
our $I18N = {
  1 => {
    ...
    'message' => 'WebGUI Authentifizierungs-Optionen'
  },
  10 => {
  ...
  13 => {
    ...
    'message' => 'Passwort-Wiederherstellung erlauben?'
  },
  14 => {
  ...
  22 => {
    ...
    'message' => 'Es gab nicht zu aktualisieren.'
  },
  3 => {
    'lastUpdated' => '1153201769',
    'message' => 'Ihr Passwort stimmt nicht. Bitte versuchen Sie es noch einmal.<br />'
  },
  4 => {
    'lastUpdated' => '1178700927',
    'message' => 'Ihr Passwort darf nicht leer sein.'
  },
  5 => {
    'lastUpdated' => '1153201795',
    'message' => 'Ihr Passwort darf nicht &quot;password&quot; lauten.<br />'
  },
  6 => {
  ...
  8 => {
    ...
    'message' => 'Ihr Passwort ist abgelaufen.'
  },
  9 => {
  ...
  'account.form.username' => {
    ...
    'message' => 'Standard Benutzername Formular Feld.'
  },
  ...
  'account.nofields' => {
    ...
    'message' => 'Standarddarstellung falls keine darzustellenden Formelemente vorhanden sind.'
  },
  'account.noform' => {
  ...
  'anon reg template title' => {
    ...
    'message' => 'WebGUI Authentifizierung Anonyme Registrierung Template'
  },
  'anonymousRegistration.isAllowed' => {
    'lastUpdated' => '1178701570',
    'message' => 'Flag, das anzeigt, ob eine anonyme Registrierung erlaubt ist oder nicht.'
  },
  'captcha failure' => {
  ...
  'deactivate account template title' => {
    ...
    'message' => 'WebGUI Authentifizierung Deaktivierung Account Template'
  },
  'display account template title' => {
    'lastUpdated' => '1178703412',
    'message' => 'WebGUI Authentifizierung Anzeige Account Template'
  },
  'displayTitle' => {
...
Sie können sich jetzt mit Ihrer Kennung und Ihrem Passwort anmelden.'
  ...
  'error password nonWordCharacters' => {
    ...
    'message' => 'Das Passwort muss mindestens %s Sonderzeichen (z.B. \'!\',\'@\',\'$\') enthalten.'
  },
  'error password requiredDigits' => {
    'lastUpdated' => '1200441286',
    'message' => 'Das Passwort muss mindestens %s Zahlen enthalten.'
  },
  ...
  'expired template title' => {
    ...
    'message' => 'WebGUI Authentifizierung Passwort Ablauf Template'
  },
  'expired.form.footer' => {
  ...
  'login.url' => {
    ...
    'message' => 'URL zur Login Seite.'
  },
  'new password help' => {
    'lastUpdated' => '1200441368',
    'message' => 'Bitte neues Passwort hier eingeben'
  },
  'new password label' => {
  ...
  'password recovery login hoverHelp' => {
    ...
    'message' => 'Benutzernamen hier eingeben'
  },
  ...
  'password recovery no username' => {
    ...
    'message' => 'Passwortwiederherstellung setzt einen Benutzernamen voraus.'
  },
  ...
  'recoverFormProfile id' => {
    ...
    'message' => 'Die ID des Profilfelds.'
  },
  ...
  'recoverPassword.isAllowed' => {
    ...
    'message' => 'Flag, das angibt, ob die Passwortwiederherstellung aktiviert ist oder nicht.'
  },
  ...
  'recovery template title' => {
    ...
    'message' => 'WebGUI Authentifizierung Passwortwiederherstellung Template'
  },
  ...
  'topicName' => {
    ...
    'message' => 'WebGUI Authentifizierung'
  },
  'use captcha' => {
  ...
  'use email as username description' => {
    'lastUpdated' => '1243495928',
    'message' => 'Wenn "ja", wird die Registrierungsmaske keinen Benutzernamen abfragen. Die E-Mailadresse wird dann als Beutzername registriert.'
  },
  'use email as username label' => {
    'lastUpdated' => '1243495915',
    'message' => 'E-Mail als Benutzername verwenden'
  },
  'validate email' => {
