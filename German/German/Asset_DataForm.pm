...
our $I18N = {
  ...
  '104 description' => {
    ...
    'message' => 'Falls ein Formular mehrere Tabs besitzt wird hier definiert, welcher Tab des Formulars dieses Feld darstellt. Anderenfalls werden alle Felder auf derselben Seite dargestellt.'
  },
  105 => {
  ...
  '16 description' => {
    ...
    'message' => 'Diese Nachricht wird dem Benutzer nach dem Abschicken der Daten angezeigt.'
  },
  17 => {
  ...
  2 => {
    ...
    'message' => 'Hier den Betreff ihrer Email'
  },
  20 => {
  ...
  6 => {
    ...
    'message' => 'Modifizierbar'
  },
  7 => {
    'lastUpdated' => '1178797058',
    'message' => 'Daten Formular bearbeiten'
  },
  73 => {
  ...
  '76 description' => {
    ...
    'message' => 'Exportieren der Daten des Formulars. Tabs als Trennzeichen zwischen den einzelnen Daten.'
  },
  77 => {
  ...
  '8 description' => {
    ...
    'message' => 'Setzt die Breite der meisten Felder in Pixeln.'
  },
  80 => {
  ...
  82 => {
    ...
    'message' => 'Daten Formular Template'
  },
  '82 description' => {
  ...
  84 => {
    ...
    'message' => 'Exportiere Tab getrennt.'
  },
  85 => {
  ...
  '86 description' => {
    ...
    'message' => 'Zeige alle Daten, die in das Daten Formular eingegeben wurden.'
  },
  87 => {
    'lastUpdated' => '1178799170',
    'message' => 'Liste Template'
  },
  '87 description' => {
  ...
  88 => {
    ...
    'message' => 'Daten Formular Liste Template'
  },
  90 => {
  ...
  'Field Position' => {
    ...
    'message' => 'Feld Position'
  },
  'Field Position description' => {
    'lastUpdated' => '1178799415',
    'message' => 'Erlaubt es ihnen die Position des Feldes direkt zu setzen. Anders als durch die Bearbeiten Icons des Feldes.'
  },
  'Submission Date' => {
  ...
  'canEdit' => {
    ...
    'message' => 'Kode, damit Tabs richtig funktionieren.'
  },
  'canViewEntries' => {
  ...
  'data form asset template variables title' => {
    ...
    'message' => 'Daten Formular Asset Template Variablen'
  },
  'data list' => {
  ...
  'edit.url' => {
    ...
    'message' => 'URL zur Seite, um diesen Eintrag zu bearbeiten.'
  },
  ...
  'editField vertical label' => {
    ...
    'message' => 'Vertikal ausrichten (alignment)'
  },
  'editField vertical label description' => {
    'lastUpdated' => '1178800810',
    'message' => 'Diese Eigenschaft legt fest, ob Radio Buttons und Checklisten horizontal oder vertikal ausgerichtet werden.'
  },
  'editField vertical subtext' => {
    'lastUpdated' => '1178800847',
    'message' => 'Diese Eigenschaft beeinflusst nur Radiolisten und Checklisten.'
  },
  ...
  'entryId' => {
    ...
    'message' => 'Die ID des aktuell betrachteten Eintrags. Diese Variable ist undefiniert, ausser der Benutzer kann das Daten Formular editieren (<strong>canEdit</strong> ist wahr).'
  },
  'entryList.label' => {
  ...
  'epoch' => {
    ...
    'message' => 'Das Datum, an dem die Daten eingegeben oder als letztes aktualisiert wurden als epoch Datum.'
  },
  'error captcha' => {
    'lastUpdated' => '1217254443',
    'message' => 'CAPTCHA wurde falsch eingegeben. Bitte versuchen Sie es noch einmal.'
  },
  'error.message' => {
  ...
  'export.tab.url' => {
    ...
    'message' => 'URL zum Exportieren der Daten in eine Datei, in der die Daten mittels Tabs voneinander getrennt sind (vgl. csv Dateien).'
  },
  'field.controls' => {
  ...
  'field.form' => {
    ...
    'message' => 'Das Formular Element dieses Feldes.'
  },
  'field.id' => {
    'lastUpdated' => '1178801409',
    'message' => 'Ein eindeutiger Bezeichner, das das Feld in der Datenbank identifiziert.'
  },
  'field.inTab' => {
    'lastUpdated' => '1178801442',
    'message' => 'Bedingung, die angibt, ob das Feld innerhalb eines Tabs ist.'
  },
  'field.isDisplayed' => {
    'lastUpdated' => '1178801474',
    'message' => 'Bedingung, die angibt, ob das Feld angezeigt wird.'
  },
  'field.isHidden' => {
    'lastUpdated' => '1178801495',
    'message' => 'Bedingung, die angibt, ob das Feld ein verstecktes Feld ist.'
  },
  'field.isMailField' => {
    'lastUpdated' => '1178801529',
    'message' => 'Bedingung, die angibt, ob das Feld nur anwesend ist, um Email zu verschicken.'
  },
  'field.isRequired' => {
    'lastUpdated' => '1178801551',
    'message' => 'Bedingung, die angibt, ob das Feld erforderlich ist.'
  },
  'field.label' => {
  ...
  'field.name' => {
    ...
    'message' => 'Der Name dieses Feldes.'
  },
  'field.subtext' => {
    'lastUpdated' => '1178802044',
    'message' => 'Eine Beschreibung des Feldes, damit der Benutzer weiss, was er in das Feld eingeben muss.'
  },
  'field.tid' => {
    'lastUpdated' => '1178802065',
    'message' => 'Die ID des Tabs, in dem das Feld sich befindet.'
  },
  'field.type' => {
    'lastUpdated' => '1178802085',
    'message' => 'Der Datentyp, der mit dem Feld assoziiert ist.'
  },
  'field.value' => {
    'lastUpdated' => '1178802182',
    'message' => 'Der Wert dieses Feldes. Falls dies neue Daten sind, so wird der Standard Wert benutzt.'
  },
  'field_loop' => {
  ...
  'form.start' => {
    ...
    'message' => 'Der Anfang des Formulars.'
  },
  'go to form' => {
    'lastUpdated' => '1178802694',
    'message' => 'Gehe zum Formular'
  },
  ...
  'ipAddress' => {
    ...
    'message' => 'Die IP Adresse des Benutzers, der diese Daten eingegeben hat.'
  },
  ...
  'listTemplateId' => {
    ...
    'message' => 'Die ID des Templates, das zur Anzeige der Listenansicht des Daten Formulars benutzt wird.'
  },
  'mail attachments' => {
  ...
  'mail attachments description' => {
    ...
    'message' => 'Muss in Verbindung mit \'mailData\' benutzt werden. Wenn Sie dies auf Ja setzen, werden alle Dateien, die via eines Datei Feld Typen abgeschickt wurden, als Email Anhang verschickt.'
  },
  'mailAttachments' => {
    'lastUpdated' => '1178803321',
    'message' => 'mailAttachments wird wahr, falls das Daten Formular so konfiguriert wurde, dass Dateien per Email verschickt werden.'
  },
  'mailData' => {
    'lastUpdated' => '1178803228',
    'message' => 'mailData wird wahr, falls ein Daten Formular so konfiguriert wurde, dass es Emails verschickt.'
  },
  'no tab' => {
  ...
  'record.data.name' => {
    ...
    'message' => 'Der Name dieses Feldes (web safe).'
  },
  'record.data.value' => {
  ...
  'record.edit.url' => {
    ...
    'message' => 'URL, um diesen Datensatz zu bearbeiten.'
  },
  'record.entryId' => {
  ...
  'record.ipAddress' => {
    ...
    'message' => 'Die IP Adresse des Benutzers, der diesen Datensatz eingegeben hat.'
  },
  ...
  'record.userId' => {
    ...
    'message' => 'Die Benutzer ID der Person, die diesen Datensatz eingegeben hat.'
  },
  'record.username' => {
    'lastUpdated' => '1178803806',
    'message' => 'Der Benutzername der Person, die diesen Datensatz eingegeben hat.'
  },
  'record_data_type' => {
    'lastUpdated' => '1192818657',
    'message' => '<p>Der Datentyp ist mit diesem Feld verbunden.</p>'
  },
  'record_loop' => {
  ...
  'tab.end' => {
    ...
    'message' => 'Kode, um Tab zu beenden.'
  },
  'tab.field.controls' => {
  ...
  'tab.field.isDisplayed' => {
    ...
    'message' => 'Bedingung, die angibt, ob dieses Feld angezeigt wird.'
  },
  'tab.field.isHidden' => {
    'lastUpdated' => '1178803967',
    'message' => 'Bedingung, die angibt, ob dieses Feld versteckt ist.'
  },
  ...
  'tab.field.isRequired' => {
    ...
    'message' => 'Bedingung, die angibt, ob dieses Feld erforderlich ist.'
  },
  'tab.field.label' => {
  ...
  'tab.field.subtext' => {
    ...
    'message' => 'Eine Beschreibung dieses Feldes, damit der Benutzer weiss, was er eintragen muss.'
  },
  'tab.field.tid' => {
  ...
  'tab.sequence' => {
    ...
    'message' => 'Eine Nummer, die angibt welcher Tab dies ist (der erste, zweite, etc.).'
  },
  'tab.start' => {
    'lastUpdated' => '1178804361',
    'message' => 'Kode, um den Tab zu starten.'
  },
  'tab.subtext' => {
  ...
  'userId' => {
    ...
    'message' => 'Die Benuter ID des Benutzers, der die Daten eingegeben hat.'
  },
  'username' => {
    'lastUpdated' => '1178804598',
    'message' => 'Der Benutzername des Benutzers, der die Daten eingegeben hat.'
  }
}
;
