...
our $I18N = {
	...
	'multisearch template title' => {
		message => q|Multi-Suche Template Variablen|,
	...
	'cache timeout' => {
		...
		lastUpdated => 1179824935
	},

	'multi search asset template variables title' => {
		message => q|Multi-Suche Asset Template Variablen|,
		lastUpdated => 1179824857
	},
	...
	'cacheTimeout' => {
		message => q|Zeitspanne in Sekunden, die die Ausgabe dieses Assets im Cache gehalten werden soll.|,
		lastUpdated => 1179825014
	},

	'for' => {
		message => q|For|,
		lastUpdated => 1179825117
	},
