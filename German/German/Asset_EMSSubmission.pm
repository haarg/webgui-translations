package WebGUI::i18n::German::Asset_EMSSubmission;
use utf8;
our $I18N = {
  'assetName' => {
    'lastUpdated' => '1258914873',
    'message' => 'Veranstaltungsplaner - Veranstaltungsregistrierung'
  },
  'comments' => {
  ...
  'your submission has been updated' => {
    ...
    'message' => 'Ihre Veranstaltungsregistrierung wurde aktualisiert.'
  }
}
;
