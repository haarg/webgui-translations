...
our $I18N = {
  ...
  1097 => {
    ...
    'message' => '<p>Diese Variablen sind in Navigation Templates verf&uuml;gbar:</p><p><strong>&quot;currentPage&quot;</strong> beinhaltet die Seite, die der Benutzer gerade betrachtet. <strong>&quot;page</strong>&quot; beinhaltet eine bestimmte Seite innerhalb der <strong>&quot;page_loop&quot;.</strong></p><p>Bei einem Verweis zu einer Seite ist jede Eigenschaft verf&uuml;gbar. Nur die meist wichtigen werden unten aufgelistet. </p>'
  },
  22 => {
  ...
  'assetsToInclude' => {
    ...
    'message' => 'Zeilenweise k&ouml;nnen T&ouml;chter von Assets zur Aufnahme in die Navigation aufgenommen werden. Vorg&auml;nger, der betreffende Asset, Siblings, abgeleitete und/oder komplette B&auml;ume.'
  },
  'currentPage.assetId' => {
  ...
  'page_loop' => {
    ...
    'message' => 'Schleife, die Seiten in einer geschachtelten, hierarchischen Form enth&auml;lt. Jede Eigenschaft jeder Seite ist verf&uuml;gbar. Einige davon sind unten aufgelistet. F&uuml;r die vollst&auml;ndige Information informieren Sie sich bitte &uuml;ber die Variabelen eines jeden Assets.'
  },
  'preview' => {
