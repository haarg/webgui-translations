...
our $I18N = {
  ...
  '1096 description' => {
    ...
    'message' => 'Wählen Sie ein Template, das für die Darstellung ihrer Navigation benutzt wird'
  },
  1097 => {
    'lastUpdated' => '1225319079',
    'message' => '<p>Diese Variablen sind in Navigation Templates verfügbar:</p><p><strong>&quot;currentPage&quot;</strong> beinhaltet die Seite, die der Benutzer gerade betrachtet. <strong>&quot;page</strong>&quot; beinhaltet eine bestimmte Seite innerhalb der <strong>&quot;page_loop&quot;.</strong></p><p>Bei einem Verweis zu einer Seite ist jede Eigenschaft verf&uuml;gbar. Nur die meist wichtigen werden unten aufgelistet. </p>'
  },
  22 => {
  ...
  '30 description' => {
    ...
    'message' => 'Soll das Menü auch Systemseiten, wie z.B. den M&uuml;lleimer, die Zwischenablage, die nicht gefunden Seite usw. anzeigen? Wenn Sie wollen, dass Admins und Content Managers Systemseiten angezeigt bekommen, dann wählen Sie hier "Ja" und benutzen das Navigation Template, um diese vor den anderen zu verstecken.'
  },
  31 => {
  ...
  '31 description' => {
    ...
    'message' => '<p>Sollen die Menüs Seiten anzeigen, die als versteckt markiert sind? Wenn Sie wollen, dass bestimmte Gruppen diese sehen, so wählen Sie hier &quot;Ja&quot; und benutzen das Navigation Template, um festzulegen wer diese Seiten im Men&uuml; sehen kann.</p><p>HINWEIS: Jeder Benutzer im Admin Modus kann automatisch alle Seiten sehen, die er auch bearbeiten darf. Egal ob diese versteckt sind oder nicht bzw. wie dieser Wert hier gesetzt ist.&nbsp;</p>'
  },
  32 => {
  ...
  '32 description' => {
    ...
    'message' => 'Sollen die Menüs auch Seiten anzeigen, die der momentan angemeldete Benutzer eigentlich nicht sehen darf?'
  },
  'Ancestor End Point' => {
  ...
  'Ancestor End Point description' => {
    ...
    'message' => 'Wenn der Startpunkt auf &quot;relativ zur aktuellen URL&quot; gesetzt ist, wie viele Ebenen über der aktuellen URL soll die Navigation beginnen.'
  },
  'Ancestors' => {
  ...
  'Relatives To Include' => {
    'lastUpdated' => '1225318560',
    'message' => 'aufzunehmende relative Links '
  },
  'Relatives To Include description' => {
    'lastUpdated' => '1178712921',
    'message' => '<p>Das Navigation Asset kann Seiten ausfiltern, die Sie nicht in der Navi aufgelistet haben wollen. Wählen Sie alle Klassen von Seiten, die aufgelistet werden sollen:</p><p>Ancestors<br />&nbsp;&nbsp;&nbsp;&nbsp; Seiten überhalb der aktuellen Seite im &quot;page tree&quot; <br />Self<br />&nbsp;&nbsp;&nbsp; Die aktuelle Seite.<br />Siblings<br />&nbsp;&nbsp;&nbsp;&nbsp; Seiten auf der selben Ebene wie die aktuelle Seite. <br />Descendents<br />&nbsp;&nbsp;&nbsp; Seiten unterhalb der aktuellen Seite im &quot;page tree&quot;.<br />Pegigree<br />&nbsp;&nbsp;&nbsp; Wenn eine andere Startseite genutzt wird, so w&auml;hlt diese Option die Ancestors, Siblings und Descendents dieser Seite. </p>'
  },
  'Self' => {
  ...
  'Start Point Type description' => {
    ...
    'message' => 'An welchem Punkt soll die Navigation beginnen, wählen Sie eine Seite an Hand einer bestimmten URL, relativ zur aktuellen URL oder eine Seite relativ zur Wurzel(Root)-Seite.'
  },
  ...
  'Where do you want to go?' => {
    'lastUpdated' => '1234738397',
    'message' => 'Wo möchten Sie hin?'
  },
  'ancestorEndPoint' => {
    'lastUpdated' => '1178713221',
    'message' => 'Abhängig vom Starttyp, wie viele Ebenen nach oben soll die Navigation Assets darstellen.'
  },
  'assetName' => {
  ...
  'assetsToInclude' => {
    'lastUpdated' => '1225318889',
    'message' => 'Zeilenweise können T&ouml;chter von Assets zur Aufnahme in die Navigation aufgenommen werden. Vorgänger, der betreffende Asset, Siblings, abgeleitete und/oder komplette B&auml;ume.'
  },
  'currentPage.assetId' => {
  ...
  'currentPage.menuTitle' => {
    ...
    'message' => 'Menütitel der aktuellen Seite'
  },
  'currentPage.newWindow' => {
    'lastUpdated' => '1178715691',
    'message' => 'Bedingung, die angibt, ob die aktuelle Seite in einem neuen Fenster geöffnet werden soll.'
  },
  ...
  'descendantEndPoint' => {
    ...
    'message' => 'Abhängig vom Starttyp, wie viele Ebenen nach unten die Assets in der Navigation aufgelistet werden sollen.'
  },
  'indent' => {
    'lastUpdated' => '1178715919',
    'message' => 'Eine Zahl, die den loop count angibt (Anzahl der Schleifendurchgänge).'
  },
  'mimeType' => {
  ...
  'mimeType description' => {
    ...
    'message' => 'Erlaubt es ihnen, den MIME Typ dieses Assets zu setzen; Nützlich, falls Sie z.B. CSS, plain text, javascript oder andere Text Dateien direkt vom WebGUI Asset System ausliefern wollen. Standard ist <strong>text/html</strong>'
  },
  'mimeType variable' => {
    'lastUpdated' => '1178716078',
    'message' => 'Der MIME Typ der Seite, die die Navigation enthält.'
  },
  ...
  'page.depthIsN' => {
    ...
    'message' => '<p>Bedingung, die angibt, ob die Tiefe einer Seite gleich N ist. Diese Variable ist nützlich, falls Sie einer bestimmten Ebene einen eigenen Style verpassen wollen.  <br /> <br />&lt;tmpl_if page.depthIs1&gt;<br /> &nbsp;&nbsp; &lt;img src=&quot;level1.gif&quot;&gt;<br />&lt;tmpl_else&gt;<br />&nbsp;&nbsp; &lt;img src=&quot;defaultBullet.gif&quot;&gt;<br />&lt;/tmpl_if&gt;</p>'
  },
  'page.hasChild' => {
  ...
  'page.indent' => {
    ...
    'message' => 'Variable, die die Einrückung der aktuellen Seite enthält. Der Standard ist drei Leerzeichen. Benutzen Sie <strong>page.indent_loop</strong>, falls Sie eine flexiblere Einr&uuml;ckung benötigen.'
  },
  'page.indent_loop' => {
  ...
  'page.isSystem' => {
    ...
    'message' => 'Bedingung, die angibt, ob diese Seite eine Systemseite ist (Mülleimer, Zwischenablage, etc.).'
  },
  'page.isTopOfBranch' => {
  ...
  'page.isUtility' => {
    ...
    'message' => 'Bedingung, die angibt, ob diese Seite ein Utility Asset ist. Utility Assets sind Assets, die typischerweise nicht direkt angesehen werden können wie z.B. Bilder, Dateien, Templates und Rich Editoren.'
  },
  'page.isViewable' => {
  ...
  'page.menuTitle' => {
    ...
    'message' => 'Der Menütitel dieser Seite.'
  },
  'page.newWindow' => {
    'lastUpdated' => '1178717542',
    'message' => 'Bedingung, die angibt, ob diese Seite in einem neuen Fenster geöffnet werden soll.'
  },
  'page.ownerUserId' => {
  ...
  'page.parent.menuTitle' => {
    ...
    'message' => 'Der Menütitel der Mutter dieser Seite.'
  },
  'page.parent.newWindow' => {
    'lastUpdated' => '1178717617',
    'message' => 'Bedingung, die angibt, ob die Mutter dieser Seite in einem neuen Fenster geöffnet werden soll.'
  },
  ...
  'reverse page loop' => {
    ...
    'message' => 'Seitenschleife rückwärts'
  },
  ...
  'reversePageLoop' => {
    ...
    'message' => 'Ist die Navigation so eingestellt, dass Sie Assets von oben nach unten (rückwärts) oder von oben nach unten darstellt. Falls wahr, dann von unten nach oben.'
  },
  'showHiddenPages' => {
  ...
  'startPoint' => {
    ...
    'message' => 'Abhängig vom Starttyp; dies gibt an von welcher Seite an die Navigation Assets auflistet.'
  },
  'startType' => {
