...
our $I18N = {
	'templateIdWeek description' => {
		message => q|Dieses Template zeigt den Kalender in der Wochenansicht.|,
	...
	'templateIdEventEdit description' => {
		message => q|Das Template f&uuml;r die Bearbeitung von Terminen.|,
	...
	'urlAdd' => {
		message => q|URL f&uuml;r das Hinzuf&uuml;gen eines Termins zum Kalender.|,
		lastUpdated => 1178794075
	},

	'templateIdPrintMonth label' => {
		message => q|Drucke Monat Template|,
	...
	'workflow generateRecurringEvents description' => {
		message => q|Diese Aktivit&auml;t erzeugt wiederkehrende Termine f&uuml;r Kalender. Sie verwaltet auch wiederkehrende Termine in der Zukunft.|,
	...
	'mdy' => {
		message => q|Das Datum dieses Tages im mm-dd-yyyy Format. yyyy -> Jahr, mm -> Monat, dd -> Tag.|,
	...
	'defaultView description' => {
		message => q|Die Standard Ansicht, die dem Benutzer angezeigt wird.|,
		lastUpdated => 1178788674
	},

	'defaultDate value current' => {
		message => q|Das aktuelle Datum|,
		lastUpdated => 1178788627
	},

	'pageNextUrl dayVar' => {
		message => q|URL zum n&auml;chsten Tag im Kalender.|,
	...
	'view calendar day title' => {
		message => q|Kalender Tagesansicht Template Variablen|,
	...
	'workflow updateFeeds description' => {
		message => q|Diese Akitivit&auml;t importiert Kalender Termine von Kalender Feeds|,
	...
	'defaultDate label' => {
		message => q|Standard Datum|,
		lastUpdated => 1178788618
	},

	'paramStart' => {
		message => q|Das Start Datum des Kalenders.|,
		lastUpdated => 1178790089
	},

	'templateIdPrintEvent label' => {
		message => q|Drucke Termin Details Template|,
		lastUpdated => 1178793901
	},

	'pagePrevUrl dayVar' => {
		message => q|URL zum vorhergehenden Tag im Kalender.|,
	...
	'hour24' => {
		message => q|Die Stunde im 24 Stunden Format. 2:00 am Nachmittag wird zu 14:00.|,
	...
	'dayAbbr' => {
		message => q|Die Abk&uuml;rzung f&uuml;r den Namen des aktuellen Tages.|,
		lastUpdated => 1178788428
	},

	'hourM' => {
		message => q|Abh&auml;ngig davon, ob die Stunde vormittags oder nachmittags stattfindet, entweder "am" oder "pm".|,
		lastUpdated => 1178789763
	},

	'urlMonth' => {
		message => q|URL zu der Monatsansicht des Kalenders.|,
	...
	'dayOfWeek' => {
		message => q|Welcher Tag der Woche ist dieser Tag; Zahl zwischen 1...7.|,
	...
	'startMonthName' => {
		message => q|Der Name des Monats in dem diese Woche beginnt.|,
	...
	'workflow updateFeeds' => {
		message => q|Erneuere Kalender Feeds|,
	...
	'defaultDate value last' => {
		message => q|Der letzte Termin im Kalender|,
	...
	'admin' => {
		message => q|Bedingung, die wahr ist, falls der Benutzer sich im Admin Modus befindet.|,
	...
	'visitorCacheTimeout description' => {
		message => q|Die Anzahl an Minuten, bevor der Cache des Besuchers (Visitor) erneuert wird.|,
	...
	'urlWeek' => {
		message => q|URL zur Wochenansicht des Kalenders.|,
	...
	'extrasUrl' => {
		message => q|Die URL zum "extras" Verzeichnis von WebGUI.|,
		lastUpdated => 1178789551
	},

	'templateIdPrintDay label' => {
		message => q|Drucke Tag Template|,
		lastUpdated => 1178793863
	},

	'hour12' => {
		message => q|Die Stunde im 12 Stunden Format. 2:00 am Nachmittag wird zu 2:00.|,
		lastUpdated => 1178789697
	},

	'templateIdPrintEvent description' => {
		message => q|Dieses Template ist f&uuml;r den Ausdruck der Details eines Termins.|,
	...
	'paramType' => {
		message => q|Die aktuelle Ansicht des Kalenders. Entweder "Tag", "Woche" oder  "Monat".|,
	...
	'endYear' => {
		message => q|Das Jahr in dem diese Woche endet.|,
	...
	'ymd' => {
		message => q|Das Datum dieses Tages im yyyy-mm-dd Format; yyyy -> Jahr, mm -> Monat, dd -> Tag.|,
	...
	'pageNextStart' => {
		message => q|Das Datum des n&auml;chsten Tages im Kalender im YYYY-MM-DD (Jahr,Monat,Tag) Format.|,
	...
	'startMonthAbbr' => {
		message => q|Die Abk&uuml;rzung des Namens des Monats in dem diese Woche beginnt.|,
	...
	'pageNextUrl weekVar' => {
		message => q|URL zur n&auml;chsten Woche im Kalender.|,
	...
	'templateIdDay description' => {
		message => q|Dieses Template zeigt den Kalender in der Tagesansicht.|,
	...
	'view calendar body' => {
		message => q|Der Kalender kann den ganzen Monat, eine Woche oder nur einen Tag anzeigen. Jede Ansicht hat seine eigenen, individuellen Template Variablen, sie teilen sich aber auch einen bestimmten Satz an Variablen. Diese werden im folgenden aufgelistet:|,
