...
our $I18N = {
  ...
  'account identifier' => {
    ...
    'lastUpdated' => '1270751501',
    'message' => 'The identifier for this plugin, from the config file.  Default identifiers are profile, inbox, friends, contributions, shop and user.'
  },
  ...
  'account title' => {
    'context' => 'template variable',
    'lastUpdated' => '1270751501',
    'message' => 'The title of this account plugin, from the config file.  Macros in the title will be expanded.'
  },
  'account url' => {
    'context' => 'template variable',
    'lastUpdated' => '1270751501',
  ...
  'is_[[IDENTIFIER]]' => {
    'context' => 'template variable',
    'lastUpdated' => '1270751501',
    'message' => '[[IDENTIFIER]] is replaced with the identifier from the plugin, for example, is_profile.  The resulting boolean will be true for this plugin.'
  },
  'is_active' => {
    'context' => 'template variable',
    'lastUpdated' => '1270751501',
  ...
  'is_method_[[METHOD]]' => {
    'context' => 'template variable',
    'lastUpdated' => '1270751501',
    'message' => '[[METHOD]] is replaced with the name of the default method for this plugin.  The default name for this method is view.'
  },
  'root_url' => {
    'context' => 'template variable',
    'lastUpdated' => '1270751501',
  ...
  'user_member_since' => {
    'context' => 'template variable',
    'lastUpdated' => '1270751501',
    'message' => 'The date this user created their account on the site, in epoch format.  Use the Date macro to change the format.'
  },
  'view_profile_url' => {
    'context' => 'template variable',
    'lastUpdated' => '1270751501',
