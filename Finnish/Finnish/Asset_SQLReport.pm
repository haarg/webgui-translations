...
our $I18N = {
	...
	'72' => {
		message => q|SQL-raportin mallipohja|,
	...
	'12' => {
		message => q|<b>Virheenselvitys:</b> Virhe: Ei tietokantayhteyttä.|,
		lastUpdated => 1043672389
	},

	'14' => {
		message => q|Vastausta / sivu|,
