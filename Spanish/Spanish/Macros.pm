...
our $I18N = {
  ...
  'macro enabled header' => {
    'lastUpdated' => 1224120932,
    'message' => '&iquest;Est&aacute; Habilitada?'
  },
  'macro name' => {
  ...
  'macros list body' => {
    'lastUpdated' => 1224121178,
    'message' => '<p>Para que un Macro pueda ser utilizado en el sitio, es necesario cumplir dos requisitos:</p><div><ol><li>El Macro debe estar disponible en el directorio de Macros en el c&oacute;digo fuente de WebGUI, usualmente lib/WebGUI/Macros/.</li><li>El Macro debe ser habilitado en la secci&oacute;n &quot;Macros&quot; del archivo WebGUI.conf. En esa secci&oacute;n, se puede asignar un Nombre Alterno (Shortcut) diferente al nombre original del Macro.</li></ol> </div> <p>La tabla siguiente muestra los Macros instalados en el sistema y que han sido configurados en el archivo WebGUI.conf apropiadamente.</p>'
  },
  'macros list title' => {
