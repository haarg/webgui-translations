package WebGUI::i18n::Spanish::Asset_Donation;
use utf8;
our $I18N = {
  'default price help' => {
    'lastUpdated' => 1215806990,
    'message' => '&iquest;Cu&aacute;nto dinero se&nbsp; pide por usuario? Tenga en cuenta que ellos pueden escribir cualquier cantidad que deseen, esto es s&oacute;lo una sugerencia'
  },
  'formHeader' => {
    'lastUpdated' => 1215806337,
    'message' => 'La parte superior del formulario de donaci&oacute;n.'
  },
  'priceField' => {
    'lastUpdated' => 1215804077,
    'message' => 'El campo en el formulario de donaci&oacute;n que el usuario escribe en lo que quieren donar.'
  },
  'donate template' => {
  ...
  'donate button' => {
    ...
    'message' => 'Adicionar Donaci&oacute;n al Carro.'
  },
  'donateButton' => {
    'lastUpdated' => 1215806426,
    'message' => 'El bot&oacute;n para el formulario de donaci&oacute;n.'
  },
  'default price' => {
    'lastUpdated' => 1215807005,
