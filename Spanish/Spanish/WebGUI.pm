...
our $I18N = {
  ...
  '77' => {
    ...
    'message' => '<p>Ese nombre de cuenta est&aacute; ya en uso por otra persona de este sitio.&nbsp; Por favor ingrese un nombre de usuario diferente.&nbsp; Las siguientes son algunas sugerencias:</p><p> %sToo<br /> %s2<br /> %s_%d </p>'
  },
  '444' => {
