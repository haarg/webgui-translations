...
our $I18N = {
	...
	'invalid card number' => {
		message => q|Er moet een geldig creditcardnummer worden ingevoerd.|,
	...
	'vendorId' => {
		message => q|Gebruikersnaam (verkopers identificatie)|,
	...
	'show terminal' => {
		message => q|Klik hier om de virtuele balie te gebruiken.|,
	...
	'cvv2' => {
		message => q|Verificatienummer (CVV2)|,
