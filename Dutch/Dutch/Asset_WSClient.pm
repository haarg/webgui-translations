...
our $I18N = {
	...
	'numResults' => {
		message => q|Het aantal dat door de cli&euml;nt gevonden is, als de uitvoer een set was.|,
		lastUpdated => 1207906490
	},
...
Of je een scalar, hash of array moet gebruiken is geheel afhankelijk van wat de SOAP service verwacht als input. Wat je terugkrijgt is ook geheel afhankelijk van wat die specifieke SOAP service teruggeeft.|,
	...
	'3 description' => {
		message => q|<p>De SOAP proxy is de volledige naam van de server en/of het script dat op de SOAP oproepen reageert. </p><p>Bijvoorbeeld: http://mydomain.com/cgi-bin/soaplistener.pl </p>|,
		lastUpdated => 1207828599
	},
	...
	'15 description' => {
		message => q|Deze optie wordt alleen getoond als Data::Structure::Util ge&iuml;nstalleerd is. SOAP oproepen geven ook UTF8 strings, zelfs als deze geen UTF8 karakters mogen bevatten. Dit converteert UTF8 karakters, zodat er geen botsing ontstaat met enig ander karakter set, die bovenaan in de code gespecificeerd is. Decodering staat standaard uit, maar zet het aan als er onleesbare tekst getoond wordt. Dit geldt speciaal voor copyright symbolen en gelijkwaardige symbolen.|,
		lastUpdated => 1207828722
	},
	...
	'14 description' => {
		message => q|Omdat een SOAP complexe data structuren als uitvoer kan geven, moet hier gespecificeerd worden welke variabele voor het afbreken van pagina's gebruikt moet worden. Wanneer er geen is gespecificeerd wordt allles op een enkele pagina getoond.|,
		lastUpdated => 1207828866
	},
