...
our $I18N = {
  'Adding %s to album' => {
    'lastUpdated' => '1254902356',
    'message' => '%s toevoegen aan album'
  },
  'Extracting archive' => {
    'lastUpdated' => '1254902367',
    'message' => 'Archief uitpakken'
  },
  'Found file: %s' => {
  ...
  'Uploading archive' => {
    'lastUpdated' => '1254902408',
    'message' => 'Archief uploaden'
  },
  'add photo' => {
  ...
  'helpvar gallery_displayTitle' => {
    'lastUpdated' => '1238424452',
    'message' => 'Of het album dat dit bestand bevat ingesteld is om zijn titel te tonen, of niet.'
  },
  ...
  'template album thumbnail alt' => {
    'lastUpdated' => '1238424325',
    'message' => 'Bekijk thumbnail voor'
  },
  'template assetName' => {
