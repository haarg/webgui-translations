...
our $I18N = {
	...
	'manual.url' => {
		message => q|De URL om de handleiding te downloaden|,
		lastUpdated => 1153241043
	},

	'18' => {
		message => q|Een andere accessoire toevoegen? |,
		lastUpdated => 1152886668
	},

	'warranty.url' => {
		message => q|De URL om de garantie te downloaden|,
		lastUpdated => 1153241675
	},

	'13 description' => {
		message => q|De brochure van dit product|,
	...
	'benefit.controls' => {
		message => q|De WebGUI management controle voor dit voordeel |,
	...
	'57' => {
		message => q|Weet u zeker dat u dit sjabloon wilt verwijderen en alle producten die het gebruiken instellen op het standaard-sjabloon? |,
		lastUpdated => 1153234367
	},

	'productNumber' => {
		message => q|Het productnummer, SKU, ISBN, of ander identificatienummer voor dit product.|,
	...
	'addspecification.url' => {
		message => q|De URL om een specificatie aan dit product toe te voegen |,
	...
	'11' => {
		message => q|Product-nummer |,
		lastUpdated => 1152839140
	},

	'addRelatedProduct.label' => {
		message => q|Het vertaalde label voor de link om een verwant product toe te voegen  |,
		lastUpdated => 1153237328
	},

	'20 description' => {
		message => q|Kies uit de lijst met producten die u al heeft toegevoegd.|,
	...
	'thumbnail3' => {
		message => q|De URL naar de miniatuur van de derde afbeelding die aan dit product is toegevoegd |,
		lastUpdated => 1153241628
	},

	'29 description' => {
		message => q|De meeteenheid voor deze specificatie. Bijvoorbeeld, als u hoogte al label heeft gekozen, is de eenheid wellicht &#39;meter&#39;.  |,
		lastUpdated => 1153088653
	},

	'relatedproduct.controls' => {
		message => q|De WebGUI management controle voor dit verwante product|,
		lastUpdated => 1153241188
	},
	...
	'specification.label' => {
		message => q|Het label voor deze specificatie. Bijvoorbeeld: hoogte |,
	...
	'benefit_loop' => {
		message => q|Deze loop bevat de voordelen van dit product |,
		lastUpdated => 1153238442
	},

	'58' => {
		message => q|Bewerk product-sjabloon|,
		lastUpdated => 1153234395
	},

	'thumbnail1' => {
		message => q|De URL naar de miniatuur van de eerste afbeelding die aan dit product is toegevoegd |,
	...
	'image2' => {
		message => q|De unieke identificatie (ID) van het storage object van de tweede afbeelding die aan dit product is toegevoegd.|,
	...
	'2' => {
		message => q|Weet u zeker dat u de link met dit accessoire wilt verwijderen?|,
		lastUpdated => 1152890690
	},

	'10 description' => {
		message => q|De prijs van het product. U kunt optioneel een tekst toevoegen, zoals &#39;moet geprijsd worden&#39;, of niets invullen |,
	...
	'24 description' => {
		message => q|Als u direct een andere eigenschap wilt toevoegen, kies &#39;ja&#39;. |,
	...
	'25' => {
		message => q|Bewerk specificatie|,
		lastUpdated => 1152918641
	},

	'28' => {
		message => q|<p>Een andere specificatie toevoegen?</p>|,
	...
	'23 description' => {
		message => q|U kunt een nieuwe eigenschap invoeren, of kiezen uit een lijst voor een ander product in het systeem|,
	...
	'addspecification.label' => {
		message => q|Het vertaalde label voor de link om een specificatie toe te voegen|,
	...
	'addRelatedProduct.url' => {
		message => q|De URL om een verwant product aan dit product toe te voegen|,
	...
	'addbenefit.label' => {
		message => q|Het vertaalde label voor de link om een voordeel toe te voegen|,
	...
	'34' => {
		message => q|Voeg een eigenschap toe|,
