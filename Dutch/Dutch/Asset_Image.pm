...
our $I18N = {
	...
	'new height' => {
		message => q|Nieuwe hoogte|,
		lastUpdated => 1149859636
	},

	'Parameters description' => {
		message => q|Hier kunnen extra parameters worden ingegeven voor de afbeelding.|,
		lastUpdated => 1149859014
	},

	'controls' => {
		message => q|De werkbalk voor het wijzigen van de afbeelding. |,
		lastUpdated => 1170687976
	},

	'new width' => {
		message => q|Nieuwe breedte|,
		lastUpdated => 1149859731
	},

	'thumbnail variable' => {
		message => q|Een url naar de thumbnail van de afbeelding.|,
		lastUpdated => 1149860055
	},

	'new width description' => {
		message => q|Vul hier de gewenste breedte in pixels in van de afbeelding. Als u 0 invult dan wordt de afbeelding naar verhouding gewijzigd op basis van de hoogte.|,
	...
	'image template description' => {
		message => q|Door het sjabloon van de Image asset te wijzigen kunt u meer informatie over de afbeelding weergeven. Hierbij valt te denken aan de thumbnail, de bestandsnaam of het plaatje zelf.  |,
		lastUpdated => 1149859478
	},

	'fileIcon' => {
		message => q|Het icoon wat het type bestand omschrijft.|,
	...
	'title' => {
		message => q|De titel van de afbeelding of, wanneer deze niet is ingevuld, de bestandsnaam.|,
		lastUpdated => 1149860114
	},

	'storageId' => {
		message => q|Het interne unieke nummer waarmee het bestand opgeslagen is.|,
