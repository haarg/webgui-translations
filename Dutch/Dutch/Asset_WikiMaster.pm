...
our $I18N = {
	'mostPopular' => {
		message => q|Deze loop bevat informatie over Wiki-pagina's die het meest populair zijn. Het aantal pagina's dat wordt weergegeven wordt bepaald in het scherm Wiki Toevoegen/Bewerken.|,
		lastUpdated => 1166546584
	},

	'mostPopularTemplateId' => {
		message => q|De ID van het sjabloon om de meest populaire pagina's in de Wiki weer te geven.|,
	...
	'thumbnail size' => {
		message => q|Grootte miniatuur-afbeeldingen|,
	...
	'recentChangesTemplateId' => {
		message => q|Het ID van het sjabloon waarmee het overzicht van recente wijzigingen in pagina's van deze Wiki wordt weergegeven. |,
		lastUpdated => 1166547801
	},

	'recentChangesUrl' => {
		message => q|Een URL om de gebruiker naar het overzicht van alle wijzigingen in de pagina's in deze Wiki te brengen. |,
		lastUpdated => 1166547881
	},

	'wiki master asset variables title' => {
		message => q|Variabelen Wiki Asset|,
		lastUpdated => 1166618751
	},

	'filterCode' => {
		message => q|Tekst die het niveau van content filtering aangeeft.|,
	...
	'addPageLabel variable' => {
		message => q|Een label - beschikbaar in verschillende talen - voor de addPageUrl variabele.|,
		lastUpdated => 1166544639
	},

	'most popular template body' => {
		message => q|Deze variabelen zijn beschikbaar in het template om de meest populaire pagina's in deze Wiki weer te geven.|,
		lastUpdated => 1166546350
	},

	'max image size help' => {
		message => q|Geef de maximale grootte op van afbeeldingen op voor deze Wiki. Wanneer je deze op 0 zet, dan wordt de maximale grootte uit de instellingen van het admin menu gebruikt. Bedenkt: het wijzigen van deze instellingen leidt er niet toe dat eerder geplaatste afbeeldingen opnieuw worden geschaald. Om dat te bereiken moet elke afbeelding opnieuw worden bewaard.|,
		lastUpdated => 1166546268
	},

	'thumbnailSize' => {
		message => q|De grootte van miniatuur-afbeeldingen voor deze Wiki|,
		lastUpdated => 1166617897
	},

	'frontPageTemplateId' => {
		message => q|De ID van het sjabloon dat gebruikt wordt om de voorpagina van de Wiki te laten zien. |,
		lastUpdated => 1166545307
	},

	'recentChangesCountFront hoverHelp' => {
		message => q|Het maximaal aantal wijzigingen dat weergegeven wordt op de voorpagina.|,
	...
	'wikiHomeLabel variable' => {
		message => q|Een - in meerdere tealen beschikbaar - label voor de variabele wikiHomeUrl|,
	...
	'groupToAdminister hoverHelp' => {
		message => q|Kies een groep van gebruikers die beheerstaken mag uitvoeren op de pagina's in deze Wiki. Denk hierbij aan het verwijderen van pagina's of paginarevisies en het beveiligen van pagina's.|,
		lastUpdated => 1166545988
	},

	'recentChangesCount label' => {
		message => q|Aantal Recente Wijzigingen|,
	...
	'mostPopularUrl' => {
		message => q|Een URL om de gebruiker naar het scherm te brengen waar de meest populaire Wiki-pagina's worden weergegeven.|,
		lastUpdated => 1166546828
	},

	'func addPage link text' => {
		message => q|Nieuwe pagina toevoegen|,
	...
	'recent changes title' => {
		message => q|Een - in meerdere talen beschikbare - titel voor het sjabloon Recente Wijzigingen. |,
		lastUpdated => 1166547460
	},

	'mostPopularTemplateId hoverHelp' => {
		message => q|Welk sjabloon zou gebruikt moeten worden om de meest populaire pagina's weer te geven. |,
		lastUpdated => 1166546791
	},

	'content filter' => {
		message => q|Content Filter gebruiken? |,
	...
	'nothingFoundLabel variable' => {
		message => q|Een - in meerdere talen beschikbaar - label om de gebruiker te melden dat er geen resultaten werden gevonden. |,
		lastUpdated => 1166546948
	},

	'groupToAdminister label' => {
		message => q|Wie kan beheren? |,
		lastUpdated => 1166546004
	},

	'recentChangesLabel variable' => {
		message => q|De vertaling voor de tekst bij de recentChangesURL.|,
	...
	'func recentChanges link text' => {
		message => q|Laat recente wijzigingen zien|,
		lastUpdated => 1166545796
	},

	'pageEditTemplateId label' => {
		message => q|Sjabloon Pagina Bewerken|,
		lastUpdated => 1166547025
	},

	'mostPopularLabel variable' => {
		message => q|De vertaling voor de tekst die gebruikt wordt voor de mostPopularURL.|,
	...
	'groupToEditPages label' => {
		message => q|Wie mag pagina's bewerken?|,
	...
	'useContentFilter' => {
		message => q|Een binaire variabele die waar is wanneer de content filtering is aangezet op deze wiki.|,
	...
	'thumbnail size help' => {
		message => q|Geef de grootte in voor miniatuur-afbeeldingen in deze Wiki. Wanneer je de waarde hier op 0 zet, zal de grootte worden gebruikt die is opgegeven bij instellingen in het admin-menu.|,
	...
	'resultsLabel variable' => {
		message => q|Een - in meerdere talen beschikbaar - label om de zoekresultaten een titel te geven.|,
	...
	'content filter description' => {
		message => q|Filter de content van de wiki pages met WebGUI's content filter systeem. Dit kan ook gebruikt worden om zelf een opmaaktaal te maken met eigen tags om zo stijlelementen te herbruiken. |,
	...
	'actionN created' => {
		message => q|Aangemaakt|,
		lastUpdated => 1166543568
	},

	'groupToAdminister' => {
		message => q|De ID van de groep die de Wiki mag beheren en pagina's mag bewerken.|,
		lastUpdated => 1166545840
	},

	'recent changes date' => {
		message => q|De datum waarop de pagina werd gewijzigd.|,
	...
	'richEditor' => {
		message => q|De ID van de editor die gebruikt wordt om Wiki-pagina's te bewerken.|,
		lastUpdated => 1166547951
	},

	'recentChangesCountFront label' => {
		message => q|Aantal recente wijzigingen op de voorpagina|,
	...
	'recentChangesCount hoverHelp' => {
		message => q|Het maximaal aantal wijzigingen dat wordt weergegeven in het overzicht met recente wijzigingen.|,
		lastUpdated => 1166547683
	},

	'filter code' => {
		message => q|Verwijder code|,
		lastUpdated => 1180654231
	},

	'recentChanges' => {
		message => q|Deze loop bevat informatie over Wiki-pagina's die recent gewijzigd zijn. Het aantal recent gewijzigde pagina's is te bepalen in het scherm Wiki Toevoegen/Bewerken. |,
		lastUpdated => 1166547644
	},

	'actionTaken' => {
		message => q|Wat er gebeurd is met deze recent gewijzigde pagina. Normaal is dit ofwel "Gewijzigd" ofwel "Aangemaakt".|,
		lastUpdated => 1166543637
	},

	'searchFormFooter' => {
		message => q|HTML code om het formulier voor het zoekveld af te sluiten.|,
