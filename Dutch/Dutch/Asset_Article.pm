...
our $I18N = {
	...
	'linkTitle' => {
		message => q|De titel van de link die werd toegevoegd aan het artikel.|,
	...
	'description.first.paragraph' => {
		message => q|De eerste paragraaf van de beschrijving. De eerste paragraaf wordt bepaald door de eerste carriage return die in de tekst wordt gevonden.|,
	...
	'72' => {
		message => q|Artikel Sjabloon|,
		lastUpdated => 1151701883
	},

	'url' => {
		message => q|De URL om dit bestand te downloaden.|,
		lastUpdated => 1151836541
	},

	'attachments help' => {
		message => q|Voeg direct bestanden en afbeeldingen toe aan dit Artikel. Gelieve nota te nemen van het feit dat deze bestanden niet toegankelijk zullen zijn via de asset manager naar andere assets.|,
		lastUpdated => 1151702538
	},

	'28' => {
		message => q|Bekijk Antwoorden|,
		lastUpdated => 1151701274
	},

	'description.first.4sentences' => {
		message => q|De eerste vier zinnen in de beschrijving. Een zin wordt bepaald door het aantal punten te tellen die in de tekst werden gevonden.|,
		lastUpdated => 1151742502
	},

	'iconUrl' => {
		message => q|De URL naar het bestandstype icoon van dit bestand.|,
...
<a href="<tmpl_var new.template>999">Lees meer...</a>|,
	...
	'storageId' => {
		message => q|Het ID van een bijlage die binnen WebGUI wordt gebruikt om bijlagen op te slaan.|,
	...
	'article asset template variables title' => {
		message => q|Artikel sjabloon variabelen|,
	...
	'description.first.50words' => {
		message => q|De eerste 50 woorden in de beschrijving. Woorden worden gedefiniëerd als karakters geschieden door spaties, dus HTML entiteiten en tags tellen als woorden.|,
		lastUpdated => 1151742304
	},

	'description.first.75words' => {
		message => q|De eerste 75 woorden in de beschrijving. Woorden worden gedefiniëerd als karakters geschieden door spaties, dus HTML entiteiten en tags tellen als woorden.|,
		lastUpdated => 1151742321
	},

	'linkURL' => {
		message => q|De URL voor de link die werd toegevoegd aan het artikel.|,
		lastUpdated => 1151824977
	},

	'attachment.icon' => {
		message => q|De URL naar de icoon afbeelding voor dit type bijvoegsel.|,
	...
	'templateId' => {
		message => q|Het ID van het Weergave sjabloon van deze Asset.|,
		lastUpdated => 1166188609
	},

	'attachments' => {
		message => q|Bijvoegsels|,
	...
	'attachment_loop' => {
		message => q|Een lus die alle bijvoegsels bevat.|,
	...
	'cacheTimeout' => {
		message => q|De tijd dat een Artikel gecached moet worden.|,
		lastUpdated => 1166188508
	},

	'12' => {
		message => q|Editeer Artikel|,
	...
	'filename' => {
		message => q|De naam van het bestand.|,
	...
	'attachment.url' => {
		message => q|De URL om dit bijvoegsel te downloaden.|,
	...
	'image.thumbnail' => {
		message => q|De URL naar de mini-weergave van de bijgevoegde afbeelding.|,
		lastUpdated => 1151744379
	},

	'attachment.name' => {
		message => q|De bestandsnaam voor dit bijvoegsel.|,
		lastUpdated => 1151702299
	},

	'link title description' => {
		message => q|Indien u een link wenst toe te voegen aan uw afbeelding, vul dan de titel van de link in in dit veld.
