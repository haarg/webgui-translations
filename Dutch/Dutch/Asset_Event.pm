...
our $I18N = {
	'startDateSecond' => {
		message => q|De seconde, weergegeven met twee cijfers, waarmee deze gebeurtenis start.|,
	...
	'endDateMinute' => {
		message => q|De minuut, weergegeven met twee cijfers, waarin deze gebeurtenis eindigt.|,
	...
	'recurId' => {
		message => q|De unieke identificatie van de herhalingsgegevens van deze gebeurtenis in de database.|,
	...
	'feedId' => {
		message => q|Een unieke identificatie voor de iCal feed.|,
	...
	'startDateYear' => {
		message => q|Het jaar waarin deze gebeurtenis start, weergegeven met vier cijfers.|,
		lastUpdated => 1189347848
	},

	'startDateEpoch' => {
		message => q|De startdatum van de gebeurtenis in epoch formaat. (Dit is het aantal seconden sinds 1 januari 1970 Zulu-tijd. Dit wordt ook wel Unix-timestamp genoemd.)|,
		lastUpdated => 1189338348
	},

	'formHeader' => {
		message => q|De HTML of het Javascript voor het begin van een formulier om een gebeurtenis toe te voegen of te wijzigen.|,
	...
	'endDateDmy' => {
		message => q|De einddatum van deze gebeurtenis, in het formaat dd-mm-yyyy. Hierbij is yyyy het jaar, mm de maand en dd de dag.|,
		lastUpdated => 1189336255
	},

	'urlMonth' => {
		message => q|De URL om de gebeurtenissen in dezelfde maand weer te geven in deze kalender|,
	...
	'endDateHms' => {
		message => q|De eindtijd van deze gebeurtenis in hh.mm.ss formaat, waarbij hh het uur is, mm de minuut en ss de seconde.|,
	...
	'event asset template variables body' => {
		message => q|Elk object maakt een aantal variabelen beschikbaar aan de meeste van zijn templates gebaseerd op interne kenmerken van het object. Deze variabelen zijn niet allemaal even bruikbaar.|,
	...
	'event common template variables body' => {
		message => q|Deze template variabelen worden gebruikt in zowel de gebeurtenis als de kalender.|,
	...
	'urlWeek' => {
		message => q|De URL om alle gebeurtenissen in dezelfde week weer te geven. |,
		lastUpdated => 1189348052
	},

	'formRecurStart' => {
		message => q|HTML datumformulier om de eerste datum waarop een gebeurtenis herhaalt in te geven.|,
	...
	'endDateDayName' => {
		message => q|De naam van de dag waarop de gebeurtenis eindigt.|,
		lastUpdated => 1189336164
	},

	'endDateMdy' => {
		message => q|De einddatum van deze gebeurtenis, in het mm-dd-yyyy formaat. Hierbij is yyyy het jaar, mm de maand en dd de dag.|,
	...
	'formSave' => {
		message => q|De HTML om een bewaar-button weer te geven om de gegevens van de gebeurtenis te bewaren.|,
	...
	'formCancel' => {
		message => q|De HTML button om het toevoegen of wijzigen van een gebeurtenis af te breken.|,
		lastUpdated => 1189336986
	},

	'prevUrl' => {
		message => q|Een URL naar de vorige gebeurtenis in de kalender. Vorige in chronologische zin.|,
