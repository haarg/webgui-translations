package WebGUI::i18n::French::Macro_r_printable;
...
our $I18N = {
	...
	'printable.text' => {
		message => q|L'&eacute;tiquette pour le lien imprimable, ou le texte que vous avez plac&eacute; dans la macro.|,
		lastUpdated => 1203454103
	},
