...
our $I18N = {
	...
	'promote help' => {
		message => q|Monter ce module d'un niveau dans la page.|,
	...
	'Edit Metadata' => {
		message => q|Modifier les M&eacute;tadonn&eacute;es|,
	...
	'Metadata Description description' => {
		message => q|Une description optionnelle pour cette m&eacute;tadonn&eacute;e. Ce texte est affich&eacute; au survol de l'onglet propri&eacute;t&eacute; du module.|,
	...
	'Delete Metadata field' => {
		message => q|Supprimer la m&eacute;tadonn&eacute;e|,
	...
	'Field Name description' => {
		message => q|Nom de cette m&eacute;tadonn&eacute;e. Elle doit &ecirc;tre unique. Il est conseill&eacute; de n'utiliser que des lettres (a-z), des nombres (0-9) ou des underscores (_) pour les noms de champ.|,
	...
	'104 description' => {
		message => q|l'URL pour ce module. Elle doit &ecirc;tre unique. Si ce champ est vide, alors une URL sera construite &agrave; partir de l'URL parente et le <strong>Titre Menu</strong>|,
