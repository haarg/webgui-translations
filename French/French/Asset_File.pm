package WebGUI::i18n::French::Asset_File;
...
our $I18N = {
	...
	'fileUrl' => {
		message => q|L'URL de ce fichier|,
		lastUpdated => 1202582276
	},
	...
	'fileSize' => {
		message => q|Le poids (octect/Ko/Mo, ect) de ce fichier.|,
		lastUpdated => 1202582263
	},
